...
angular.module('wanderwagon-webapp').run(['$templateCache', function($templateCache) {
  ...
  $templateCache.put('views/destination-detail.html',
    ...
    "                        </center>--> </div> </div> </div> </ng-owl-carousel> </uib-accordion-group> </uib-accordion> </div> </section> <section> <h2 class=\"paul-title\"> Why we love {{detail.name}} ? </h2> <div class=\"underline\" style=\"margin-bottom:2rem\"> </div>  <p style=\"color: #67747c; font-family: Benton Sans,Helvetica Neue,Helvetica,Arial,sans-serif; font-size: 1.8rem; font-style:\n" +
    "                    italic; line-height: 1.8; margin: 0 auto 5.5rem; text-align: center; width:70%\"> \" {{detail.reasonToLoveDest}} \" </p> <div ui-sref=\"travel-plan \" class=\"center-block\" style=\"width:70%; cursor:pointer\"> <a class=\"button button-3d button-rounded button-blue loved-it-button\"> Loved it ? We got plans for you !</a> </div> <div class=\"custom-padding\" style=\"margin:4% 0\"> <h2 class=\"paul-title\"> After {{detail.name}}, Where Next ? </h2> <ng-owl-carousel class=\"owl-theme\" owl-items=\"placesData\" owl-properties=\"sliderProperties\" owl-ready=\"ready($api)\"> <div class=\"paul-slide-new\" style=\"padding:2% 2% 2% 2%\" data-ng-repeat=\"item in placesData\"> <img ui-sref=\"destination.detail({id: item.placeId})\" style=\"object-fit:cover; width:100%; height:100%\" class=\"owl-lazy\" data-src=\"{{item.imageUrl}}\"> <span class=\"paul-slider-caption\"> {{item.placeName}}</span> </div> </ng-owl-carousel> </div> </section> "
  );
  ...
  $templateCache.put('views/home.html',
    ...
    "          <source media=\"(min-width: 960px)\" srcset=\"https://www.roughguides.com/wp-content/uploads/2016/04/pier-440339-660x420.jpg 960w\">\n" +
    "          <source media=\"(min-width: 640px)\" srcset=\"https://www.roughguides.com/wp-content/uploads/2016/04/pier-440339-660x420.jpg 640w\">--> <img ng-src=\"{{blog[1].imageUrl}}\" alt=\"{{blog[1].title}}\"> </picture> </div> <div class=\"text blog-content-right\"> <h3 style=\"cursor:pointer\" ui-sref=\"blog.detail({postId: blog[1].id})\" class=\"blog-title\"> {{blog[1].title}}</h3> <div class=\"blog-content\"> <p>{{blog[1].description}}... </p> <div class=\"feature-info\"> <span class=\"icon-calendar3\"> {{blog[1].time}} • {{blog[1].user.name}}</span> </div> </div> </div> </div> </section> <section style=\"margin-top:5%\"> <div class=\"home-form-bg\"> <!--<div class=\"text_over_image\">\n" +
    "        {{postDetail.title}}\n" +
