...
angular.module('wanderwagon-webapp').run(['$templateCache', function($templateCache) {
  ...
  $templateCache.put('views/holi.html',
    ...
    "background-size: cover; height:100vh\"> </div> <section id=\"about\"> <div class=\"container clearfix\"> <div> <h2 class=\"paul-title\" style=\"margin-top:5%\"> Mathura ki Holi </h2> <div class=\"underline\" style=\"margin-bottom:2rem\"> </div> </div> <div class=\"custom-para-event\"> <p style=\"margin-bottom:20px\">How do you see yourself playing Holi this year? Same old or Some bold? It is for you to decide. Kyuki Mathura ki Holi nahi kheli, to kya kia? Let us help you check one more item off your bucket list as you soak into the vibrancy of this festival.</p> <p style=\"margin-bottom:20px\"> Travel back in time to witness the authentic Holi of Mathura. Follow the steps of Lord Krishna and let the inner kid take over. Let go of the inhibitions and let others watch you bring your A-Game. This Holi there's no stopping you; Cause what happens in Mathura stays in Mathura! </p> <p style=\"font-size:2.2rem; margin-bottom:20px\"> <strong> Celebrations start a week in advance and here is when and where you should be while celebrating Holi in Mathura :- </strong> </p> <ul style=\"padding-left:30px\"> <li> <p style=\"margin-bottom:20px\"> <strong> Lathmar Holi - 24.02.2018-25.02.2018 </strong> <br> What literally translates to a festival of lathis (sticks) and colours, Lathmar Holi lives up to every bit of its name. </p> </li> <li> <p style=\"margin-bottom:20px\"> <strong> Phoolon Wali Holi - 26.02.2018 </strong> <br> Flowers and showers, Phoolon Wali Holi lives up to every bit of its name. </p> </li> <li> <p style=\"margin-bottom:20px\"> <strong>Widow’s Holi- 27.02.2018 </strong> <br> The only day when a widow’s saree turns into a blank canvas to be filled with colours. </p> </li> <li> <p style=\"margin-bottom:20px\"> <strong> Holi at Vrindavan- 01.03.2018 </strong> <br> The festivities begin as the gates to the temple of Banke Bihari open up for you to play Holi with the lord himself. </p> </li> <li> <p style=\"margin-bottom:20px\"> <strong> Holi at Mathura- 01.03.2018 </strong> <br> Witness the rest of the Holi along the lanes of Mathura. </p> </li> <li> <p style=\"margin-bottom:20px\"> <strong> Holika Dahan- 01.03.2018 </strong> <br> Celebrate the victory of good over evil as you watch the effigy of Holika burn down to ashes. </p> </li> <li> <p style=\"margin-bottom:20px\"> <strong>Grand Holi- 02.03.2018 </strong> <br> Travel back in time and witness the authentic holi of Mathura amongst the riot of colours. </p> </li> <li> <p style=\"margin-bottom:20px\"> <strong> Huranga- 03.03.2018 </strong> <br>It’s not over yet! Let the inner child take over a day after. </p> </li> </ul> </div> </div> </section> <section class=\"clearfix custom-padding\" id=\"places\"> <h2 style=\"margin-top:5%\" class=\"paul-title\"> Our Plans, Your Choice </h2> <div class=\"underline\" style=\"margin-bottom:5rem\"> </div> <div class=\"row row-centered\"> <div style=\"margin-bottom:2%\" ng-repeat=\"plan in travelPlans\" class=\"col-sm-6 col-centered col-fixed\"> <div class=\"photo\" style=\"cursor:pointer; width: 100%;\n" +
    "      height: 100%;\n" +
    "      overflow: hidden;\n" +
    "      position: relative;\n" +
    "      text-align: center;\n" +
