 ...
 */
angular.module('wanderwagon-webapp')
  .controller('LoginCtrl', ["$scope", "$cookies", "auth", "$location", "ngProgressFactory", "$auth", function ($scope, $cookies, auth, $location, ngProgressFactory, $auth) {
 ...
 */
angular.module('wanderwagon-webapp')
  .controller('HomeCtrl', ["$scope", "$timeout", "mockRemoteSvc", "$document", "$window", function ($scope, $timeout, mockRemoteSvc, $document, $window) {
 ...
 */
angular.module('wanderwagon-webapp')
  .controller('BlogListCtrl', ["$scope", "mockRemoteSvc", "$location", function ($scope, mockRemoteSvc, $location) {
 ...
 */
angular.module('wanderwagon-webapp')
  .controller('DestinationCtrl', ["$scope", "mockRemoteSvc", function ($scope, mockRemoteSvc) {
 ...
 */
angular.module('wanderwagon-webapp')
  .controller('DestinationDetailCtrl', ["$scope", "$stateParams", "mockRemoteSvc", "$document", function ($scope, $stateParams, mockRemoteSvc, $document) {
 ...
 */
angular.module('wanderwagon-webapp')
  .controller('TravelPlanCtrl', ["$scope", "mockRemoteSvc", "$document", function ($scope, mockRemoteSvc, $document) {
...
angular.module('wanderwagon-webapp').run(['$templateCache', function($templateCache) {
  ...
  $templateCache.put('views/blog-detail.html',
    ...
    "							============================================= --> <div class=\"custom-para notopmargin\"> <div class=\"entry-title\"> <h3 style=\"cursor:pointer\" ui-sref=\"blog.detail({postId: post.id})\" style=\"line-height:1.2142857142857142;margin-top:0;margin-right:0;margin-bottom:0;margin-left:0;font-size:28px;font-weight:600;color:#2c3643\"> For rivers, seas and slopes at their most inviting</h3> </div> <p>{{postDetail.description}}</p> <p>Nullam id dolor id nibh ultricies vehicula ut id elit. <a href=\"#\">Curabitur blandit tempus porttitor</a>. Integer posuere erat a ante venenatis dapibus posuere velit aliquet. Cras justo odio, dapibus ac facilisis in, egestas eget quam. Vestibulum id ligula porta felis euismod semper. Donec id elit non mi porta gravida at eget metus. Vestibulum id ligula porta felis euismod semper.</p> <div class=\"entry-title\"> <h3 style=\"cursor:pointer\" ui-sref=\"blog.detail({postId: post.id})\" style=\"line-height:1.2142857142857142;margin-top:0;margin-right:0;margin-bottom:0;margin-left:0;font-size:28px;font-weight:600;color:#2c3643\"> For rivers, seas and slopes at their most inviting</h3> </div> <p>Integer posuere erat a ante venenatis dapibus posuere velit aliquet. Cras mattis consectetur purus sit amet fermentum. Donec id elit non mi porta gravida at eget metus.</p> <p>Morbi leo risus, porta ac consectetur ac, vestibulum at eros. Aenean lacinia bibendum nulla sed consectetur. Cras justo odio, dapibus ac facilisis in, egestas eget quam. <a href=\"#\">Nullam quis risus eget urna</a> mollis ornare vel eu leo. Integer posuere erat a ante venenatis dapibus posuere velit aliquet.</p> <p>Duis mollis, est non commodo luctus, nisi erat porttitor ligula, eget lacinia odio sem nec elit. Cras mattis consectetur purus sit amet fermentum. Morbi leo risus, porta ac consectetur ac, vestibulum at eros. Praesent commodo cursus magna, vel scelerisque nisl consectetur et.</p> <div class=\"entry-title\"> <h3 style=\"cursor:pointer\" ui-sref=\"blog.detail({postId: post.id})\" style=\"line-height:1.2142857142857142;margin-top:0;margin-right:0;margin-bottom:0;margin-left:0;font-size:28px;font-weight:600;color:#2c3643\"> For rivers, seas and slopes at their most inviting</h3> </div> <p>Nullam id dolor id nibh ultricies vehicula ut id elit. Curabitur blandit tempus porttitor. Integer posuere erat a ante venenatis dapibus posuere velit aliquet. Cras justo odio, dapibus ac facilisis in, egestas eget quam. Vestibulum id ligula porta felis euismod semper. Donec id elit non mi porta gravida at eget metus. Vestibulum id ligula porta felis euismod semper.</p> <!-- Post Single - Content End --> <div> <img ng-src=\"images/home-bg.jpg\" alt=\"Blog Single\" width=\"auto\" height=\"auto\"> </div> <div class=\"clear\"></div> <!-- Post Single - Share\n" +
    "								============================================= --> <div class=\"si-share noborder clearfix\"> <span>Share this Post:</span> <div> <a socialshare socialshare-provider=\"facebook\" socialshare-text=\"For rivers, seas and slopes at their most inviting\" socialshare-hashtags=\"wanderwagon\" socialshare-description=\"Nullam id dolor id nibh ultricies vehicula ut id elit. Curabitur blandit tempus porttitor. Integer posuere\n" +
    ...
    "                Vestibulum id ligula porta felis euismod semper.\" socialshare-media=\"images/home-bg.jpg\" socialshare-url=\"http://wanderwagon.com/\" class=\"social-icon si-borderless si-facebook\"> <i class=\"icon-facebook\"></i> <i class=\"icon-facebook\"></i> </a> <a socialshare socialshare-provider=\"twitter\" socialshare-text=\"For rivers, seas and slopes at their most inviting\" socialshare-hashtags=\"wanderwagon\" socialshare-description=\"Nullam id dolor id nibh ultricies vehicula ut id elit. Curabitur blandit tempus porttitor. Integer posuere\n" +
    "                erat a ante venenatis dapibus posuere velit aliquet. Cras justo odio, dapibus ac facilisis in, egestas eget\n" +
    "                quam. Vestibulum id ligula porta felis euismod semper. Donec id elit non mi porta gravida at eget metus.\n" +
    "                Vestibulum id ligula porta felis euismod semper.\" socialshare-media=\"images/home-bg.jpg\" socialshare-url=\"http://wanderwagon.com/\" class=\"social-icon si-borderless si-twitter\"> <i class=\"icon-twitter\"></i> <i class=\"icon-twitter\"></i> </a> <a socialshare socialshare-provider=\"google\" socialshare-text=\"For rivers, seas and slopes at their most inviting\" socialshare-hashtags=\"wanderwagon\" socialshare-description=\"Nullam id dolor id nibh ultricies vehicula ut id elit. Curabitur blandit tempus porttitor. Integer posuere\n" +
    "                erat a ante venenatis dapibus posuere velit aliquet. Cras justo odio, dapibus ac facilisis in, egestas eget\n" +
    "                quam. Vestibulum id ligula porta felis euismod semper. Donec id elit non mi porta gravida at eget metus.\n" +
    "                Vestibulum id ligula porta felis euismod semper.\" socialshare-media=\"images/home-bg.jpg\" socialshare-url=\"http://wanderwagon.com/\" class=\"social-icon si-borderless si-gplus\"> <i class=\"icon-gplus\"></i> <i class=\"icon-gplus\"></i> </a> <!--<a href=\"#\" class=\"social-icon si-borderless si-pinterest\">\n" +
    ...
    "                    <i class=\"icon-email3\"></i>\n" +
    "                  </a>--> </div> </div> <!-- Post Single - Share End --> </div> </div> <!-- .entry end --> <!-- Post Author Info\n" +
    ...
    "            </div>\n" +
    "\n" +
    "          </div>--> </div> </div> <!-- .sidebar end --> </div> </div> <div class=\"container\"> <div class=\"fancy-title title-center title-dotted-border topmargin\"> <h3>Looking for similar experiences ?</h3> </div> <div class=\"entry clearfix\"> <div class=\"row\"> <div id=\"carousel-example-generic\" class=\"carousel slide hidden-xs\" data-ride=\"carousel\"> <a style=\"background-color: rgb(255, 255, 255);\n" +
    "    border: 0px;\n" +
    "    border-radius: 50%;\n" +
    "    cursor: pointer;\n" +
    "    display: block;\n" +
    ...
    "    top: 0px;\n" +
    "    z-index: 20;\n" +
    "    left: -2.22222em\" class=\"btn\" href=\"#carousel-example-generic\" data-slide=\"prev\"> <i style=\"margin:7px 0 0 0px; font-size:15px; font-weight:600\" class=\"icon-angle-left\"></i> </a> <a style=\"background-color: rgb(255, 255, 255);\n" +
    "    border: 0px;\n" +
    "    border-radius: 50%;\n" +
    "    cursor: pointer;\n" +
    "    display: block;\n" +
  ...
  $templateCache.put('views/blog-list.html',
    ...
    "         <span>Let's Wander</span> <i style=\"margin-left:10px;\" class=\"icon-angle-right\"></i></a>--> </div> </div> </div> <div class=\"content-wrap\"> <div class=\"container clearfix\"> <div class=\"si-sticky visible-md visible-lg\"> <a href=\"#\" class=\"social-icon si-facebook\" data-animate=\"bounceInLeft\"> <i class=\"icon-facebook\"></i> <i class=\"icon-facebook\"></i> </a> <a href=\"#\" class=\"social-icon si-gplus\" data-animate=\"bounceInLeft\" data-delay=\"100\"> <i class=\"icon-instagram\"></i> <i class=\"icon-instagram\"></i> </a> <a href=\"#\" class=\"social-icon si-linkedin\" data-animate=\"bounceInLeft\" data-delay=\"600\"> <i class=\"icon-linkedin\"></i> <i class=\"icon-linkedin\"></i> </a> <a href=\"#\" class=\"social-icon si-twitter\" data-animate=\"bounceInLeft\" data-delay=\"600\"> <i class=\"icon-twitter\"></i> <i class=\"icon-twitter\"></i> </a> <a href=\"#\" class=\"social-icon si-gplus\" data-animate=\"bounceInLeft\" data-delay=\"600\"> <i class=\"icon-gplus\"></i> <i class=\"icon-gplus\"></i> </a> </div> </div> </div> <!-- Content\n" +
    "		============================================= --> <section id=\"content\"> <div class=\"container clearfix\"> <!-- Post Content\n" +
    "					============================================= --> <div class=\"postcontent nobottommargin clearfix\"> <!-- Posts\n" +
    "						============================================= --> <div id=\"posts\" class=\"post-timeline clearfix\"> <div class=\"timeline-border\"></div> <div ng-repeat=\"post in posts\" class=\"entry clearfix\"> <div class=\"entry-timeline\"> <!--10<span>{{post.date | date:'MMM'}}</span>--> 10<span>May</span> <div class=\"timeline-divider\"></div> </div> <div class=\"entry-image\"> <a ui-sref=\"blog.detail({postId: post.id})\" data-lightbox=\"image\"><img class=\"image_fade\" ng-src=\"{{post.imageUrl}}\" alt=\"Standard Post with Image\"></a> </div> <div class=\"entry-title\"> <h3 style=\"cursor:pointer\" ui-sref=\"blog.detail({postId: post.id})\" style=\"line-height:1.2142857142857142;margin-top:0;margin-right:0;margin-bottom:0;margin-left:0;font-size:28px;font-weight:600;color:#2c3643\"> For rivers, seas and slopes at their most inviting</h3> </div> <ul class=\"entry-meta clearfix\"> <li><a href=\"#\"><i class=\"icon-user\"></i> {{post.author}}</a></li> <li><i class=\"icon-folder-open\"></i> <a href=\"#\">General</a></li> <li><a><i class=\"icon-comments\"></i> {{post.comments}} Comment(s)</a></li> </ul> <div class=\"entry-content\"> <p>{{post.description}}</p> <a href=\"\" ui-sref=\"blog.detail({postId: post.id})\" class=\"more-link\">Read More</a> </div> </div> </div> <!-- #posts end --> <!-- Pagination\n" +
    ...
    "            </div>\n" +
    "\n" +
    "          </div>--> </div> </div> <!-- .sidebar end --> </div> </section> <!-- #content end --> "
  );
  ...
  $templateCache.put('views/destination-detail.html',
    "<div style=\"background-color:#000;background-image: url('images/destination-detail-bg.jpg');background-size: cover; height:100vh\"> <div class=\"container clearfix\"> <div class=\"center-block slider-caption-center\"> <h2 class=\"text-center\" style=\"font-size:68px;letter-spacing:0px;font-weight:600;color:#fff; margin-top:23%\" data-caption-animate=\"fadeInUp\">{{detail.name}}</h2> <p style=\"font-size:3rem; font-style:italic; color:#fff\" class=\"text-center\">{{detail.title}}</p> </div> </div> </div> <!-- Header\n" +
    "		============================================= --> <header style=\"height:50px\" sticky id=\"header\" class=\"full-header\"> <div class=\"container clearfix\"> <!-- Primary Navigation\n" +
    "					============================================= --> <nav style=\"margin-left:30%; margin-right:20%\" id=\"primary-menu\" class=\"style-2\"> <ul class=\"one-page-menu\"> <li> <a href=\"#about\" du-smooth-scroll=\"\" du-scrollspy=\"\" duration=\"800\" style=\"cursor:pointer;color:#444;padding:10px 15px\"> <div>About</div> </a> </li> <li> <a href=\"#howToReach\" du-smooth-scroll=\"\" du-scrollspy=\"\" duration=\"800\" style=\"cursor:pointer;color:#444;padding:10px 15px\"> <div>How to reach</div> </a> </li> <li> <a href=\"#places\" du-smooth-scroll=\"\" du-scrollspy=\"\" duration=\"800\" style=\"cursor:pointer;color:#444;padding:10px 15px\"> <div>Places to visit</div> </a> </li> <li> <a href=\"#activities\" du-smooth-scroll=\"\" du-scrollspy=\"\" duration=\"800\" style=\"cursor:pointer;color:#444;padding:10px 15px\"> <div>Activities</div> </a> </li> </ul> </nav> <!-- #primary-menu end --> </div> </header> <!-- #header end --> <section id=\"about\"> <div class=\"container clearfix\" style=\"height:100vh\"> <div> <h2 style=\"text-align:center;margin:6rem 0 8rem 0;letter-spacing:-0.45px;line-height:1;font-weight:300;font-size:3.8rem\"> About <div style=\"display:block;height:2px;width:30px;background:#dc221a;margin-left:auto;margin-right:auto;margin-bottom:0;margin-top:15px\"> </div> </h2> </div> <div class=\"center-block custom-para\" style=\"width:60%\"> <p>{{detail.about}}</p> </div> <div class=\"center-block\" style=\"width:40%; border:1px solid #F5F5F5; border-radius:2%\"> <h2 style=\"text-align:center;margin:2rem 0 2rem 0;letter-spacing:-0.45px;line-height:1;font-weight:300;font-size:1.8rem\"> Overview <div style=\"display:block;height:2px;width:30px;background:#dc221a;margin-left:auto;margin-right:auto;margin-bottom:0;margin-top:15px\"> </div> </h2> <div style=\"margin: 30px\"> <h5 class=\"pull-left\"><i style=\"padding-right:10px\" class=\"icon-calendar i-alt\"></i>Best Time To Visit</h5> <p style=\"margin-right: 40px\" class=\"pull-right\">{{detail.overview.bestTimeToVisit}}</p> </div> <span class=\"clearfix\"></span> <div style=\"margin: 0 30px 30px 30px\"> <h5 class=\"pull-left\"><i style=\"padding-right:10px\" class=\"icon-calendar i-alt\"></i>Days Required</h5> <p style=\"margin-right: 40px\" class=\"pull-right\">{{detail.overview.daysRequired}}</p> </div> <span class=\"clearfix\"></span> <div style=\"margin: 0 30px 30px 30px\"> <h5 class=\"pull-left\"><i style=\"padding-right:10px\" class=\"icon-folder i-alt\"></i>Category</h5> <p style=\"margin-right: 40px\" class=\"pull-right\">{{detail.overview.category}}</p> </div> </div> </div> </section> <section id=\"howToReach\"> <div class=\"container clearfix\" style=\"height:100vh\"> <div style=\"margin-top:100px\"> <h2 style=\"text-align:center;margin:8rem 0 8rem 0;letter-spacing:-0.45px;line-height:1;font-weight:300;font-size:3.8rem\"> How to reach <div style=\"display:block;height:2px;width:30px;background:#dc221a;margin-left:auto;margin-right:auto;margin-bottom:0;margin-top:15px\"> </div> </h2> </div> <div class=\"center-block\" style=\"width:700px\"> <div class=\"feature-box\"> <div class=\"custom-fbox-icon\"> <i class=\"icon-plane i-alt\"></i> </div> <span style=\"font:bold; font-size:20px\">Airport</span> <p>{{detail.howToReach.airport}} </p> </div> <div class=\"feature-box\"> <div class=\"custom-fbox-icon\"> <i class=\"icon-train i-alt\"></i> </div> <span style=\"font:bold; font-size:20px\">Railways</span> <p>{{detail.howToReach.railways}} </p> </div> <div class=\"feature-box\"> <div class=\"custom-fbox-icon\"> <i class=\"icon-road i-alt\"></i> </div> <span style=\"font:bold; font-size:20px\">Roadways</span> <p>{{detail.howToReach.roadways}} </p> </div> </div> </div> </section> <section id=\"places\"> <div class=\"container clearfix\" style=\"height:100vh\"> <div> <h2 style=\"text-align:center;margin:6rem 0 2rem 0;letter-spacing:-0.45px;line-height:1;font-weight:300;font-size:3.8rem\"> Places to visit <div style=\"display:block;height:2px;width:30px;background:#dc221a;margin-left:auto;margin-right:auto;margin-bottom:0;margin-top:15px\"> </div> </h2> </div> <div class=\"row\"> <div id=\"carousel-example-generic\" class=\"carousel slide hidden-xs\" data-ride=\"carousel\"> <a style=\"background-color: rgb(255, 255, 255);\n" +
    "    border: 0px;\n" +
    "    border-radius: 50%;\n" +
    "    cursor: pointer;\n" +
    "    display: block;\n" +
    ...
    "    top: 0;\n" +
    "    z-index: 20;\n" +
    "    right: -2.22222em\" class=\"btn\" href=\"#carousel-example-generic\" data-slide=\"next\"> <i style=\"margin:7px 0 0 0; font-size:15px; font-weight:600\" class=\"icon-angle-right\"></i></a> <!-- Wrapper for slides <--> <div class=\"carousel-inner\"> <div class=\"item active\" style=\"padding:2% 0 2% 2%\"> <div class=\"row\"> <div class=\"col-sm-3 nopadding\"> <div ng-click=\"header1.isOpen = !header1.isOpen ; getTravelInspirationDetail(placesData[0].id)\" style=\"cursor:pointer\"> <div class=\"paul-slide\"> <img style=\"object-fit:cover; width:100%; height:100%\" ng-src=\"{{placesData[0].imageUrl}}\" class=\"img-responsive\" alt=\"a\"> </div> <span class=\"paul-slider-caption\"> {{placesData[0].text}}</span> </div> </div> <div class=\"col-sm-3 nopadding\"> <div ng-click=\"header1.isOpen = !header1.isOpen ; getTravelInspirationDetail(placesData[1].id)\" style=\"cursor:pointer\"> <div class=\"paul-slide\"> <img style=\"object-fit:cover; width:100%; height:100%\" ng-src=\"{{placesData[1].imageUrl}}\" class=\"img-responsive\" alt=\"a\"> </div> <span class=\"paul-slider-caption\"> {{placesData[1].text}}</span> </div> </div> <div class=\"col-sm-3 nopadding\"> <div ng-click=\"header1.isOpen = !header1.isOpen ; getTravelInspirationDetail(slideplacesDatar[2].id)\" style=\"cursor:pointer\"> <div class=\"paul-slide\"> <img style=\"object-fit:cover; width:100%; height:100%\" ng-src=\"{{placesData[2].imageUrl}}\" class=\"img-responsive\" alt=\"a\"> </div> <span class=\"paul-slider-caption\"> {{placesData[2].text}}</span> </div> </div> <div class=\"col-sm-3 nopadding\"> <div ng-click=\"header1.isOpen = !header1.isOpen ; getTravelInspirationDetail(placesData[3].id)\" style=\"cursor:pointer\"> <div class=\"paul-slide\"> <img style=\"object-fit:cover; width:100%; height:100%\" ng-src=\"{{placesData[3].imageUrl}}\" class=\"img-responsive\" alt=\"a\"> </div> <span class=\"paul-slider-caption\"> {{placesData[3].text}}</span> </div> </div> </div> </div> <div class=\"item\" style=\"padding:2% 2% 2% 0%\"> <div class=\"row\"> <div class=\"col-sm-3 nopadding\"> <div ng-click=\"header1.isOpen = !header1.isOpen ; getTravelInspirationDetail(placesData[4].id)\" style=\"cursor:pointer\"> <div class=\"paul-slide\"> <img style=\"object-fit:cover; width:100%; height:100%\" ng-src=\"{{placesData[4].imageUrl}}\" class=\"img-responsive\" alt=\"a\"> </div> <span class=\"paul-slider-caption\"> {{placesData[4].text}}</span> </div> </div> <div class=\"col-sm-3 nopadding\"> <div ng-click=\"header1.isOpen = !header1.isOpen ; getTravelInspirationDetail(placesData[5].id)\" style=\"cursor:pointer\"> <div class=\"paul-slide\"> <img style=\"object-fit:cover; width:100%; height:100%\" ng-src=\"{{placesData[5].imageUrl}}\" class=\"img-responsive\" alt=\"a\"> </div> <span class=\"paul-slider-caption\"> {{placesData[5].text}}</span> </div> </div> <div class=\"col-sm-3 nopadding\"> <div ng-click=\"header1.isOpen = !header1.isOpen ; getTravelInspirationDetail(placesData[6].id)\" style=\"cursor:pointer\"> <div class=\"paul-slide\"> <img style=\"object-fit:cover; width:100%; height:100%\" ng-src=\"{{placesData[6].imageUrl}}\" class=\"img-responsive\" alt=\"a\"> </div> <span class=\"paul-slider-caption\"> {{placesData[6].text}}</span> </div> </div> <div class=\"col-sm-3 nopadding\"> <div ng-click=\"header1.isOpen = !header1.isOpen ; getTravelInspirationDetail(placesData[7].id)\" style=\"cursor:pointer\"> <div class=\"paul-slide\"> <img style=\"object-fit:cover; width:100%; height:100%\" ng-src=\"{{placesData[7].imageUrl}}\" class=\"img-responsive\" alt=\"a\"> </div> <span class=\"paul-slider-caption\"> {{placesData[7].text}}</span> </div> </div> </div> </div> </div> </div> </div> </div> <div id=\"accordion\" class=\"clearfix\"> <uib-accordion> <uib-accordion-group is-open=\"header1.isOpen\"> <div class=\"center-block\" style=\"width:80%\" ng-show=\"header1.isOpen\"> <div> <h2 style=\"text-align:center;margin:2rem 0 2rem 0;letter-spacing:-0.45px;line-height:1;font-weight:300;font-size:3.8rem\"> Name <div style=\"display:block;height:2px;width:30px;background:#dc221a;margin-left:auto;margin-right:auto;margin-bottom:0;margin-top:15px\"> </div> </h2> </div> <div class=\"pull-left\" style=\"width:30%\"> <a href=\"images/blog3.jpg\"><img height=\"350px\" width=\"100%\" src=\"images/blog3.jpg\" alt=\"Standard Post with Image\"></a> </div> <div class=\"pull-right\" style=\"width:70%; padding-left:10px\"> <h4 style=\"line-height:1.2142857142857142;font-size:18px;font-weight:200;color:#2c3643\"> What is it.....</h4> <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Cupiditate, asperiores quod est tenetur in. Eligendi, deserunt, blanditiis est quisquam doloribus voluptate id aperiam ea ipsum magni aut perspiciatis rem voluptatibus officia eos rerum. </p> <h4 style=\"line-height:1.2142857142857142;font-size:18px;font-weight:200;color:#2c3643\"> Overview</h4> <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Cupiditate, asperiores quod est tenetur in. Eligendi, deserunt. </p> <h4 style=\"line-height:1.2142857142857142;font-size:18px;font-weight:200;color:#2c3643\"> How to reach</h4> <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Cupiditate, asperiores quod est tenetur in. Eligendi, deserunt. </p> <div> <h4 class=\"pull-left\" style=\"line-height:1.2142857142857142;font-size:18px;font-weight:200;color:#2c3643\"> Timings - <span>8am - 6pm</span></h4> <h4 class=\"pull-right\" style=\"line-height:1.2142857142857142;font-size:18px;font-weight:200;color:#2c3643\"> Pricing - <span>₹7999</span></h4> </div> </div> </div> </uib-accordion-group> </uib-accordion> </div> </section> <section id=\"activities\"> <div class=\"container clearfix\" style=\"height:100vh\"> <div> <h2 style=\"text-align:center;margin:6rem 0 2rem 0;letter-spacing:-0.45px;line-height:1;font-weight:300;font-size:3.8rem\"> Activities <div style=\"display:block;height:2px;width:30px;background:#dc221a;margin-left:auto;margin-right:auto;margin-bottom:0;margin-top:15px\"> </div> </h2> </div> <div class=\"row\"> <div id=\"carousel-example-generic\" class=\"carousel slide hidden-xs\" data-ride=\"carousel\"> <a style=\"background-color: rgb(255, 255, 255);\n" +
    "    border: 0px;\n" +
    "    border-radius: 50%;\n" +
    "    cursor: pointer;\n" +
    "    display: block;\n" +
    ...
    "    top: 0;\n" +
    "    z-index: 20;\n" +
    "    right: -2.22222em\" class=\"btn\" href=\"#carousel-example-generic\" data-slide=\"next\"> <i style=\"margin:7px 0 0 0; font-size:15px; font-weight:600\" class=\"icon-angle-right\"></i></a> <!-- Wrapper for slides <--> <div class=\"carousel-inner\"> <div class=\"item active\" style=\"padding:2% 0 2% 2%\"> <div class=\"row\"> <div class=\"col-sm-3 nopadding\"> <div ng-click=\"header2.isOpen = !header2.isOpen ; getTravelInspirationDetail(activitiesData[0].id)\" style=\"cursor:pointer\"> <div class=\"paul-slide\"> <img style=\"object-fit:cover; width:100%; height:100%\" ng-src=\"{{activitiesData[0].imageUrl}}\" class=\"img-responsive\" alt=\"a\"> </div> <span class=\"paul-slider-caption\"> {{activitiesData[0].text}}</span> </div> </div> <div class=\"col-sm-3 nopadding\"> <div ng-click=\"header2.isOpen = !header2.isOpen ; getTravelInspirationDetail(activitiesData[1].id)\" style=\"cursor:pointer\"> <div class=\"paul-slide\"> <img style=\"object-fit:cover; width:100%; height:100%\" ng-src=\"{{activitiesData[1].imageUrl}}\" class=\"img-responsive\" alt=\"a\"> </div> <span class=\"paul-slider-caption\"> {{activitiesData[1].text}}</span> </div> </div> <div class=\"col-sm-3 nopadding\"> <div ng-click=\"header2.isOpen = !header2.isOpen ; getTravelInspirationDetail(activitiesData[2].id)\" style=\"cursor:pointer\"> <div class=\"paul-slide\"> <img style=\"object-fit:cover; width:100%; height:100%\" ng-src=\"{{activitiesData[2].imageUrl}}\" class=\"img-responsive\" alt=\"a\"> </div> <span class=\"paul-slider-caption\"> {{activitiesData[2].text}}</span> </div> </div> <div class=\"col-sm-3 nopadding\"> <div ng-click=\"header2.isOpen = !header2.isOpen ; getTravelInspirationDetail(activitiesData[3].id)\" style=\"cursor:pointer\"> <div class=\"paul-slide\"> <img style=\"object-fit:cover; width:100%; height:100%\" ng-src=\"{{activitiesData[3].imageUrl}}\" class=\"img-responsive\" alt=\"a\"> </div> <span class=\"paul-slider-caption\"> {{activitiesData[3].text}}</span> </div> </div> </div> </div> <div class=\"item\" style=\"padding:2% 2% 2% 0%\"> <div class=\"row\"> <div class=\"col-sm-3 nopadding\"> <div ng-click=\"header2.isOpen = !header2.isOpen ; getTravelInspirationDetail(activitiesData[4].id)\" style=\"cursor:pointer\"> <div class=\"paul-slide\"> <img style=\"object-fit:cover; width:100%; height:100%\" ng-src=\"{{activitiesData[4].imageUrl}}\" class=\"img-responsive\" alt=\"a\"> </div> <span class=\"paul-slider-caption\"> {{activitiesData[4].text}}</span> </div> </div> <div class=\"col-sm-3 nopadding\"> <div ng-click=\"header2.isOpen = !header2.isOpen ; getTravelInspirationDetail(activitiesData[5].id)\" style=\"cursor:pointer\"> <div class=\"paul-slide\"> <img style=\"object-fit:cover; width:100%; height:100%\" ng-src=\"{{activitiesData[5].imageUrl}}\" class=\"img-responsive\" alt=\"a\"> </div> <span class=\"paul-slider-caption\"> {{activitiesData[5].text}}</span> </div> </div> <div class=\"col-sm-3 nopadding\"> <div ng-click=\"header2.isOpen = !header2.isOpen ; getTravelInspirationDetail(activitiesData[6].id)\" style=\"cursor:pointer\"> <div class=\"paul-slide\"> <img style=\"object-fit:cover; width:100%; height:100%\" ng-src=\"{{activitiesData[6].imageUrl}}\" class=\"img-responsive\" alt=\"a\"> </div> <span class=\"paul-slider-caption\"> {{activitiesData[6].text}}</span> </div> </div> <div class=\"col-sm-3 nopadding\"> <div ng-click=\"header2.isOpen = !header2.isOpen ; getTravelInspirationDetail(activitiesData[7].id)\" style=\"cursor:pointer\"> <div class=\"paul-slide\"> <img style=\"object-fit:cover; width:100%; height:100%\" ng-src=\"{{activitiesData[7].imageUrl}}\" class=\"img-responsive\" alt=\"a\"> </div> <span class=\"paul-slider-caption\"> {{activitiesData[7].text}}</span> </div> </div> </div> </div> </div> </div> </div> </div> <div id=\"accordion1\" class=\"clearfix\"> <uib-accordion> <uib-accordion-group is-open=\"header2.isOpen\"> <div class=\"center-block\" style=\"width:80%\" ng-show=\"header2.isOpen\"> <div> <h2 style=\"text-align:center;margin:2rem 0 2rem 0;letter-spacing:-0.45px;line-height:1;font-weight:300;font-size:3.8rem\"> Name <div style=\"display:block;height:2px;width:30px;background:#dc221a;margin-left:auto;margin-right:auto;margin-bottom:0;margin-top:15px\"> </div> </h2> </div> <div class=\"pull-left\" style=\"width:30%\"> <a href=\"images/blog3.jpg\"><img height=\"350px\" width=\"100%\" src=\"images/blog3.jpg\" alt=\"Standard Post with Image\"></a> </div> <div class=\"pull-right\" style=\"width:70%; padding-left:10px\"> <h4 style=\"line-height:1.2142857142857142;font-size:18px;font-weight:200;color:#2c3643\"> What is it.....</h4> <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Cupiditate, asperiores quod est tenetur in. Eligendi, deserunt, blanditiis est quisquam doloribus voluptate id aperiam ea ipsum magni aut perspiciatis rem voluptatibus officia eos rerum. </p> <h4 style=\"line-height:1.2142857142857142;font-size:18px;font-weight:200;color:#2c3643\"> Overview</h4> <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Cupiditate, asperiores quod est tenetur in. Eligendi, deserunt. </p> <h4 style=\"line-height:1.2142857142857142;font-size:18px;font-weight:200;color:#2c3643\"> How to reach</h4> <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Cupiditate, asperiores quod est tenetur in. Eligendi, deserunt. </p> <div> <h4 class=\"pull-left\" style=\"line-height:1.2142857142857142;font-size:18px;font-weight:200;color:#2c3643\"> Timings - <span>8am - 6pm</span></h4> <h4 class=\"pull-right\" style=\"line-height:1.2142857142857142;font-size:18px;font-weight:200;color:#2c3643\"> Pricing - <span>₹7999</span></h4> </div> </div> </div> </uib-accordion-group> </uib-accordion> </div> </section> <section> <div class=\"topmargin\"> <h2 style=\"text-align:center;margin:8rem 0 8rem 0;letter-spacing:-0.45px;line-height:1;font-weight:300;font-size:3.8rem\"> Why we love Destination ? <div style=\"display:block;height:2px;width:30px;background:#dc221a;margin-left:auto;margin-right:auto;margin-bottom:0;margin-top:15px\"> </div> </h2> </div> <p style=\"color: #67747c;\n" +
    ...
    "    text-align: center;\n" +
    "    width:70%\"> \" Known for its old temple, a fresh water spring, water falls and slate quarries. Bhagsunag can be approached by road. The Bhagsu fall is one of the main attractions of Mcleodganj. You can take a dip in the chilly water of fall....\"<a style=\"cursor:pointer; margin-left:5px\" class=\"read-more\">READ MORE <span style=\"font-size:10px\" class=\"icon-chevron-right\"></span></a> </p> <div ui-sref=\"travel-plan\" class=\"center-block\" style=\"width:70%; cursor:pointer\"> <h2 style=\"background:#1ABC9C;border:1px solid #F5F5F5; color:#fff; padding:2%; text-align:center;margin:8rem 0 8rem 0;letter-spacing:-0.45px;line-height:1;font-weight:300;font-size:3.8rem\"> Loved it ? We got plans for you ! </h2> </div> <div class=\"container\" style=\"padding-bottom:2%\"> <div class=\"center-block\" style=\"width:70%\"> <h2 style=\"text-align:center;margin:8rem 0 2rem 0;letter-spacing:-0.45px;line-height:1;font-weight:300;font-size:3.8rem\"> After Dharamshala, Where Next ? </h2> </div> <div class=\"row\"> <div id=\"carousel-example-generic\" class=\"carousel slide hidden-xs\" data-ride=\"carousel\"> <a style=\"background-color: rgb(255, 255, 255);\n" +
    "    border: 0px;\n" +
    "    border-radius: 50%;\n" +
    "    cursor: pointer;\n" +
    "    display: block;\n" +
    ...
    "    top: 0;\n" +
    "    z-index: 20;\n" +
    "    right: -2.22222em\" class=\"btn\" href=\"#carousel-example-generic\" data-slide=\"next\"> <i style=\"margin:7px 0 0 0; font-size:15px; font-weight:600\" class=\"icon-angle-right\"></i></a> <!-- Wrapper for slides <--> <div class=\"carousel-inner\"> <div class=\"item active\" style=\"padding:2% 0 2% 2%\"> <div class=\"row\"> <div class=\"col-sm-3 nopadding\"> <div ui-sref=\"travel-plan\" style=\"cursor:pointer\"> <div class=\"paul-slide\"> <img style=\"object-fit:cover; width:100%; height:100%\" ng-src=\"{{activitiesData[0].imageUrl}}\" class=\"img-responsive\" alt=\"a\"> </div> <span class=\"paul-slider-caption\"> {{activitiesData[0].text}}</span> </div> </div> <div class=\"col-sm-3 nopadding\"> <div ui-sref=\"travel-plan\" style=\"cursor:pointer\"> <div class=\"paul-slide\"> <img style=\"object-fit:cover; width:100%; height:100%\" ng-src=\"{{activitiesData[1].imageUrl}}\" class=\"img-responsive\" alt=\"a\"> </div> <span class=\"paul-slider-caption\"> {{activitiesData[1].text}}</span> </div> </div> <div class=\"col-sm-3 nopadding\"> <div ui-sref=\"travel-plan\" style=\"cursor:pointer\"> <div class=\"paul-slide\"> <img style=\"object-fit:cover; width:100%; height:100%\" ng-src=\"{{activitiesData[2].imageUrl}}\" class=\"img-responsive\" alt=\"a\"> </div> <span class=\"paul-slider-caption\"> {{activitiesData[2].text}}</span> </div> </div> <div class=\"col-sm-3 nopadding\"> <div ui-sref=\"travel-plan\" style=\"cursor:pointer\"> <div class=\"paul-slide\"> <img style=\"object-fit:cover; width:100%; height:100%\" ng-src=\"{{activitiesData[3].imageUrl}}\" class=\"img-responsive\" alt=\"a\"> </div> <span class=\"paul-slider-caption\"> {{activitiesData[3].text}}</span> </div> </div> </div> </div> <div class=\"item\" style=\"padding:2% 2% 2% 0%\"> <div class=\"row\"> <div class=\"col-sm-3 nopadding\"> <div ui-sref=\"travel-plan\" style=\"cursor:pointer\"> <div class=\"paul-slide\"> <img style=\"object-fit:cover; width:100%; height:100%\" ng-src=\"{{activitiesData[4].imageUrl}}\" class=\"img-responsive\" alt=\"a\"> </div> <span class=\"paul-slider-caption\"> {{activitiesData[4].text}}</span> </div> </div> <div class=\"col-sm-3 nopadding\"> <div ui-sref=\"travel-plan\" style=\"cursor:pointer\"> <div class=\"paul-slide\"> <img style=\"object-fit:cover; width:100%; height:100%\" ng-src=\"{{activitiesData[5].imageUrl}}\" class=\"img-responsive\" alt=\"a\"> </div> <span class=\"paul-slider-caption\"> {{activitiesData[5].text}}</span> </div> </div> <div class=\"col-sm-3 nopadding\"> <div ui-sref=\"travel-plan\" style=\"cursor:pointer\"> <div class=\"paul-slide\"> <img style=\"object-fit:cover; width:100%; height:100%\" ng-src=\"{{activitiesData[6].imageUrl}}\" class=\"img-responsive\" alt=\"a\"> </div> <span class=\"paul-slider-caption\"> {{activitiesData[6].text}}</span> </div> </div> <div class=\"col-sm-3 nopadding\"> <div ui-sref=\"travel-plan\" style=\"cursor:pointer\"> <div class=\"paul-slide\"> <img style=\"object-fit:cover; width:100%; height:100%\" ng-src=\"{{activitiesData[7].imageUrl}}\" class=\"img-responsive\" alt=\"a\"> </div> <span class=\"paul-slider-caption\"> {{activitiesData[7].text}}</span> </div> </div> </div> </div> </div> </div> </div> </div> </section> "
  );
  ...
  $templateCache.put('views/destination.html',
    ...
    "		============================================= --> <section id=\"content\"> <div class=\"topmargin\"> <h2 style=\"text-align:center;margin-bottom:4rem;letter-spacing:-0.45px;line-height:1;font-weight:300;font-size:3.8rem\"> Destinations <div style=\"display:block;height:2px;width:30px;background:#dc221a;margin-left:auto;margin-right:auto;margin-bottom:0;margin-top:15px\"> </div> </h2> </div> <div class=\"container\"> <div class=\"row row-centered\"> <div style=\"margin-bottom:2%\" ng-repeat=\"destination in destinations\" class=\"col-xs-4 col-centered col-fixed\"> <!--<div class=\"item\" style=\"width:100%;\">\n" +
    "          <div style=\"cursor:pointer;\" ui-sref=\"destination.detail({id: destination.id})\">\n" +
    "            <img  width=\"380\" height=\"255\" ng-src=\"{{destination.imageUrl}}\" />\n" +
    "            <div style=\"background-color: rgba(0,0,0,.66); width:100%;\" >\n" +
    "                      <span class=\"paul-slider-caption\">{{destination.name}}</span></div>\n" +
    "          </div>\n" +
    "        </div>--> <a ui-sref=\"destination.detail({id: destination.id})\"> <div class=\"photo\" style=\"cursor:pointer; width: 100%;\n" +
    "    height: 100%;\n" +
    "    float: left;\n" +
    "    overflow: hidden;\n" +
    "    position: relative;\n" +
    ...
    "    transition: all 0.3s;\n" +
    "    margin: 0 auto\" ng-src=\"{{destination.imageUrl}}\"> <div class=\"overlay\" style=\"width: 100%;\n" +
    "    height: 100%;\n" +
    "    position: absolute;\n" +
    "    overflow: hidden;\n" +
    "    top: 0;\n" +
  ...
  $templateCache.put('views/home.html',
    " <div style=\"background-color:#000;background-image: url('images/home-bg.jpg');background-size: cover; height:100vh\"> <div class=\"container clearfix\"> <div class=\"slider-caption-center\"> <h2 class=\"text-center\" style=\"margin-bottom:0px;font-size:32px;letter-spacing:1px;font-weight:600;color:#fff;margin-top:25%\"> WANDERWAGON MAKES YOUR GROUP TRIP</h2> <h2 class=\"text-center\" style=\"margin-bottom:0px;font-size:32px;letter-spacing:1px;font-weight:600;color:#fff\"> {{changingText}}</h2> <p style=\"font-size:2.5rem; margin-bottom:50px; color:#fff\" class=\"text-center\"> \"Wanderwagon is the perfect partner to plan that much awaited trip with your buddies\" </p> <a href=\"#content\" du-smooth-scroll=\"\" du-scrollspy=\"\" duration=\"800\" class=\"custom-button center-block text-center\"> <span>Let's Wander</span> <i style=\"margin-left:10px\" class=\"icon-angle-right\"></i></a> </div> </div> </div> <section id=\"content\" style=\"padding:0 6% 10% 6%\"> <div style=\"height:100vh\"> <h2 class=\"paul-title\"> Travel Inspiration </h2> <p style=\"font-size:2rem\" class=\"text-center\"> Your choices, Your friends, Your travel plans </p><div style=\"display:block;height:2px;width:30px;background:#dc221a;margin-left:auto;margin-right:auto;margin-bottom:0\"> </div> <p></p> <div class=\"row\"> <div id=\"carousel-example-generic\" class=\"carousel slide hidden-xs\" data-ride=\"carousel\"> <a style=\"background-color: rgb(255, 255, 255);\n" +
    "    border: 0px;\n" +
    "    border-radius: 50%;\n" +
    "    cursor: pointer;\n" +
    "    display: block;\n" +
    ...
    "    top: 0;\n" +
    "    z-index: 20;\n" +
    "    right: -2.22222em\" class=\"btn\" href=\"#carousel-example-generic\" data-slide=\"next\"> <i style=\"margin:7px 0 0 0; font-size:15px; font-weight:600\" class=\"icon-angle-right\"></i></a> <!-- Wrapper for slides <--> <div class=\"carousel-inner\"> <div class=\"item active\" style=\"padding:2% 2% 2% 0\"> <div class=\"row\"> <div class=\"col-sm-3 nopadding\"> <div ng-click=\"header.isOpen = !header.isOpen ; getTravelInspirationDetail(slider[0].id)\" style=\"cursor:pointer\"> <div class=\"paul-slide\"> <img style=\"object-fit:cover; width:100%; height:100%\" ng-src=\"{{slider[0].imageUrl}}\" class=\"img-responsive\" alt=\"a\"> </div> <span class=\"paul-slider-caption\"> {{slider[0].text}}</span> </div> </div> <div class=\"col-sm-3 nopadding\"> <div ng-click=\"header.isOpen = !header.isOpen ; getTravelInspirationDetail(slider[1].id)\" style=\"cursor:pointer\"> <div class=\"paul-slide\"> <img style=\"object-fit:cover; width:100%; height:100%\" ng-src=\"{{slider[1].imageUrl}}\" class=\"img-responsive\" alt=\"a\"> </div> <span class=\"paul-slider-caption\"> {{slider[1].text}}</span> </div> </div> <div class=\"col-sm-3 nopadding\"> <div ng-click=\"header.isOpen = !header.isOpen ; getTravelInspirationDetail(slider[2].id)\" style=\"cursor:pointer\"> <div class=\"paul-slide\"> <img style=\"object-fit:cover; width:100%; height:100%\" ng-src=\"{{slider[2].imageUrl}}\" class=\"img-responsive\" alt=\"a\"> </div> <span class=\"paul-slider-caption\"> {{slider[2].text}}</span> </div> </div> <div class=\"col-sm-3 nopadding\"> <div ng-click=\"header.isOpen = !header.isOpen ; getTravelInspirationDetail(slider[3].id)\" style=\"cursor:pointer\"> <div class=\"paul-slide\"> <img style=\"object-fit:cover; width:100%; height:100%\" ng-src=\"{{slider[3].imageUrl}}\" class=\"img-responsive\" alt=\"a\"> </div> <span class=\"paul-slider-caption\"> {{slider[3].text}}</span> </div> </div> </div> </div> <div class=\"item\" style=\"padding:2% 2% 2% 0%\"> <div class=\"row\"> <div class=\"col-sm-3 nopadding\"> <div ng-click=\"header.isOpen = !header.isOpen ; getTravelInspirationDetail(slider[4].id)\" style=\"cursor:pointer\"> <div class=\"paul-slide\"> <img style=\"object-fit:cover; width:100%; height:100%\" ng-src=\"{{slider[4].imageUrl}}\" class=\"img-responsive\" alt=\"a\"> </div> <span class=\"paul-slider-caption\"> {{slider[4].text}}</span> </div> </div> <div class=\"col-sm-3 nopadding\"> <div ng-click=\"header.isOpen = !header.isOpen ; getTravelInspirationDetail(slider[5].id)\" style=\"cursor:pointer\"> <div class=\"paul-slide\"> <img style=\"object-fit:cover; width:100%; height:100%\" ng-src=\"{{slider[5].imageUrl}}\" class=\"img-responsive\" alt=\"a\"> </div> <span class=\"paul-slider-caption\"> {{slider[5].text}}</span> </div> </div> <div class=\"col-sm-3 nopadding\"> <div ng-click=\"header.isOpen = !header.isOpen ; getTravelInspirationDetail(slider[6].id)\" style=\"cursor:pointer\"> <div class=\"paul-slide\"> <img style=\"object-fit:cover; width:100%; height:100%\" ng-src=\"{{slider[6].imageUrl}}\" class=\"img-responsive\" alt=\"a\"> </div> <span class=\"paul-slider-caption\"> {{slider[6].text}}</span> </div> </div> <div class=\"col-sm-3 nopadding\"> <div ng-click=\"header.isOpen = !header.isOpen ; getTravelInspirationDetail(slider[7].id)\" style=\"cursor:pointer\"> <div class=\"paul-slide\"> <img style=\"object-fit:cover; width:100%; height:100%\" ng-src=\"{{slider[7].imageUrl}}\" class=\"img-responsive\" alt=\"a\"> </div> <span class=\"paul-slider-caption\"> {{slider[7].text}}</span> </div> </div> </div> </div> </div> </div> </div> </div> </section> <div id=\"accordion1\" class=\"container\"> <uib-accordion> <uib-accordion-group is-open=\"header.isOpen\"> <div class=\"container\"> <div class=\"row row-centered\"> <div style=\"margin-bottom:2%\" ng-repeat=\"inspiration in inspirations\" class=\"col-xs-4 col-centered col-fixed\"> <a ui-sref=\"destination.detail({id: inspiration.id})\"> <div class=\"photo\" style=\"cursor:pointer; width: 100%;\n" +
    "    height: 100%;\n" +
    "    float: left;\n" +
    "    overflow: hidden;\n" +
    "    position: relative;\n" +
    "    text-align: center;\n" +
    "    margin: 10px 0\"> <img class=\"img-responsive\" style=\"height:250px; display: block;\n" +
    "    position: relative;\n" +
    "    -webkit-transition: all 0.3s;\n" +
    "    transition: all 0.3s;\n" +
    "    margin: 0 auto\" ng-src=\"{{inspiration.imageUrl}}\"> <div class=\"overlay\" style=\"width: 100%;\n" +
    "    height: 100%;\n" +
    "    position: absolute;\n" +
    "    overflow: hidden;\n" +
    "    top: 0;\n" +
    ...
    "    font-weight: 400;\n" +
    "    padding: 10px;\n" +
    "    background: rgba(0,0,0,0.6)\" class=\"ng-binding\">{{inspiration.name}}</h2> </div> </div> </a> </div> </div> </div> </uib-accordion-group> </uib-accordion> </div> <section id=\"content\" class=\"container\"> <div class=\"topmargin\"> <h2 ui-sref=\"blog.list\" style=\"cursor:pointer\" class=\"paul-title\"> The Blog </h2> <p style=\"font-size:2rem\" class=\"text-center\"> Live the wanderlust through words </p><div style=\"display:block;height:2px;width:30px;background:#dc221a;margin-left:auto;margin-right:auto;margin-bottom:0\"> </div> <p></p> </div> <div style=\"overflow:hidden; margin-bottom:-5%\"> <div ui-sref=\"blog.list\" class=\"image\" style=\"height: 350px; width: 50%;\n" +
    "    float: left;background-size: cover;\n" +
    "    background-position: 50%;\n" +
    "    transition: .4s;\n" +
    "    overflow: hidden\"> <picture> <!--<source media=\"(min-width: 1280px)\" srcset=\"https://www.roughguides.com/wp-content/uploads/2016/04/pier-440339-660x420.jpg 1280w\">\n" +
    "        <source media=\"(min-width: 960px)\" srcset=\"https://www.roughguides.com/wp-content/uploads/2016/04/pier-440339-660x420.jpg 960w\">\n" +
    "        <source media=\"(min-width: 640px)\" srcset=\"https://www.roughguides.com/wp-content/uploads/2016/04/pier-440339-660x420.jpg 640w\">--> <img ng-src=\"{{blog[0].imageUrl}}\" alt=\"{{blog[0].title}}\"> </picture> </div> <div class=\"text\" style=\"margin-top:70px; height: 350px; width: 50%;\n" +
    "    float: left;text-align: left;\n" +
    "    padding: 10px 20px;\n" +
    "    position: relative\"> <h3 style=\"cursor:pointer\" ui-sref=\"blog.list\" style=\"line-height:1.2142857142857142;margin-top:0;margin-right:0;margin-bottom:0;margin-left:0;font-size:28px;font-weight:600;color:#2c3643\"> {{blog[0].title}}</h3> <div class=\"entry-content\"> <p>{{blog[0].description}}... </p> <div class=\"feature-info\"> <span class=\"icon-calendar3\"> {{blog[0].dateTime}} • {{blog[0].author}}</span> </div> </div> </div> </div> <div style=\"overflow:hidden\"> <div ui-sref=\"blog.list\" class=\"image\" style=\"height: 350px; width: 50%;\n" +
    "    float: right;background-size: cover;\n" +
    "    background-position: 50%;\n" +
    "    transition: .4s;\n" +
    "    overflow: hidden\"> <picture> <!--<source media=\"(min-width: 1280px)\" srcset=\"https://www.roughguides.com/wp-content/uploads/2016/04/pier-440339-660x420.jpg 1280w\">\n" +
    "        <source media=\"(min-width: 960px)\" srcset=\"https://www.roughguides.com/wp-content/uploads/2016/04/pier-440339-660x420.jpg 960w\">\n" +
    "        <source media=\"(min-width: 640px)\" srcset=\"https://www.roughguides.com/wp-content/uploads/2016/04/pier-440339-660x420.jpg 640w\">--> <img ng-src=\"{{blog[1].imageUrl}}\" alt=\"{{blog[1].title}}\"> </picture> </div> <div class=\"text\" style=\"margin-top:70px; height: 350px; width: 50%;\n" +
    "    float: right;text-align: right;\n" +
    "    padding: 10px 20px;\n" +
    "    position: relative\"> <h3 style=\"cursor:pointer\" ui-sref=\"blog.list\" style=\"line-height:1.2142857142857142;margin-top:0;margin-right:0;margin-bottom:0;margin-left:0;font-size:28px;font-weight:600;color:#2c3643\"> {{blog[1].title}}</h3> <div class=\"entry-content\"> <p>{{blog[1].description}}... </p> <div class=\"feature-info\"> <span class=\"icon-calendar3\"> {{blog[1].dateTime}} • {{blog[1].author}}</span> </div> </div> </div> </div> </section> <section> <div style=\"background-color:#000;background-image: url('https://resources.luxuryretreats.com/www/images/vr5/home_inquire.jpg');background-size: cover;position:relative; width:100%;  height:100vh\"> <!--<div class=\"text_over_image\">\n" +
    "        {{postDetail.title}}\n" +
    "      </div>--> <div style=\"width:40%; height:100vh; float:left; position:absolute; left:0px; top:0px; z-index:1; background-color: rgba(0,0,0,.66); padding:5px; color: #FFF; font-weight:bold\"> <div style=\"padding:18% 5% 17% 5%\"> <div> <div> <h3 style=\"margin: 0;font-size: 25px;font-weight: 600;\n" +
    "    line-height: normal;\n" +
    "    letter-spacing: 2px;\n" +
    "    color:#FFF\">Not Sure Where to Begin?</h3> <p style=\"color:#FFF; font-size:15px\">Complete this form &amp; we'll get right back to you!</p> </div> </div> <form id=\"\"> <div style=\"padding:0px\" class=\"col-sm-6\"> <label style=\"color:#FFF; text-transform:capitalize\">First Name<span class=\"asterisk\">*</span></label> <input class=\"form-control\" id=\"{{inquireFirstName}}\" type=\"text\" placeholder=\"*Required\" value=\"{{firstName}}\" data-parsley-trim-value=\"true\" required data-prefill=\"firstName\"> </div> <div class=\"col-sm-6\"> <label style=\"color:#FFF; text-transform:capitalize\">Last Name</label> <input class=\"form-control\" id=\"{{inquireLastName}}\" type=\"text\" value=\"{{lastName}}\" data-parsley-trim-value=\"true\" data-prefill=\"lastName\"> </div> <div style=\"padding:10px 0 0 0\" class=\"col-sm-6\"> <label style=\"color:#FFF; text-transform:capitalize\">Email<span class=\"asterisk\">*</span></label> <input class=\"form-control\" id=\"{{inquireEmail}}\" type=\"email\" value=\"{{email}}\" placeholder=\"*Required\" data-parsley-trim-value=\"true\" required data-prefill=\"email\"> </div> <div style=\"padding-top:10px\" class=\"col-sm-6\"> <label style=\"color:#FFF; text-transform:capitalize\">Phone Number<span class=\"asterisk\">*</span></label> <div class=\"inquireTelContainer\"> <input class=\"form-control\" id=\"{{inquireTel}}\" placeholder=\"*Required\" value=\"{{tel}}\" type=\"tel\" data-parsley-intphone=\"{{inquireTel}}\" data-parsley-cnic required data-prefill=\"phone\"> <input id=\"{{inquireCountry}}\" type=\"hidden\" data-prefill=\"country\"> </div> </div> <div style=\"padding:10px 0 0 0\" class=\"col-sm-6\"> <label style=\"color:#FFF; text-transform:capitalize\" for=\"form-condition-10\">I would like to go to...</label> <select ng-click=\"display5={display:'block'}\" id=\"form-condition-10\" name=\"form-condition-10\" class=\"required sm-form-control\"> <option value=\"\">-- Select One --</option> <option value=\"5K\"> Rishikesh</option> <option value=\"5K to 10K\">Manali</option> <option value=\"10K to 15K\">Dharamshala</option> <option value=\"15K to 20K\">Ladakh</option> <option value=\"more than 20K\">Shimla</option> </select> </div> <div style=\"padding-top:10px\" class=\"col-sm-6\"> <label style=\"color:#FFF; text-transform:capitalize\" for=\"form-condition-10\">In the month of...</label> <select ng-click=\"display5={display:'block'}\" id=\"form-condition-10\" name=\"form-condition-10\" class=\"required sm-form-control\"> <option value=\"\">Travel Dates TBC</option> <option value=\"5K\">January</option> <option value=\"5K to 10K\">February</option> <option value=\"10K to 15K\">March</option> <option value=\"15K to 20K\">April</option> <option value=\"more than 20K\">May</option> <option value=\"5K\">June</option> <option value=\"5K to 10K\">July</option> <option value=\"10K to 15K\">August</option> <option value=\"15K to 20K\">September</option> <option value=\"more than 20K\">October</option> <option value=\"10K to 15K\">November</option> <option value=\"15K to 20K\">December</option> </select> </div> <div style=\"width:97%\"> <label style=\"padding-top: 10px; color:#FFF; text-transform:capitalize\">What's the occasion?<span class=\"asterisk\">*</span></label> <textarea style=\"max-width:425px; max-height:500px\" class=\"form-control\" placeholder=\"Tell us a little bit about what you're looking for.\"></textarea> </div> <div style=\"padding:20px 0 0 0; text-transform:capitalize\" class=\"col-sm-12\"> <button style=\"margin:0px !important; width:97%; height:70px\" id=\"{{inquireSubmit}}\" class=\"button buttonPrimary\">Submit Inquiry</button> </div> </form> </div> </div> </div> </section> <section> <div class=\"topmargin\"> <h2 class=\"instaText\" style=\"text-align:center;margin-bottom:4rem;letter-spacing:-0.45px;line-height:1;font-weight:300;font-size:3.8rem\"> On Instagram @ wanderwagon </h2> </div> <!--<marquee  behavior=\"scroll\" direction=\"left\" loop=\"infinite\">\n" +
    "    <img ng-repeat=\"image in destinations\" style=\"margin:2%;\" ng-src=\"{{image.imageUrl}}\" width=\"200\" height=\"150\" alt=\"Instafeed\">\n" +
    "  </marquee>--> <div class=\"marquee\"> <div class=\"edge\"></div> <ul class=\"slideContainer\" id=\"money_start\"> <li ng-repeat=\"image in destinations\" class=\"slideItem\"> <img style=\"margin:2%\" ng-src=\"{{image.imageUrl}}\" width=\"200\" height=\"150\" alt=\"Instafeed\"> </li> </ul> </div> </section> "
  );


  $templateCache.put('views/login.html',
    "<section id=\"content\" style=\"background: rgba(73,155,234,1);\n" +
    "background: -moz-linear-gradient(left, rgba(73,155,234,1) 0%, rgba(73,155,234,1) 47%, rgba(50,138,231,1) 66%, rgba(32,124,229,1) 81%);\n" +
    "background: -webkit-gradient(left top, right top, color-stop(0%, rgba(73,155,234,1)), color-stop(47%, rgba(73,155,234,1)), color-stop(66%, rgba(50,138,231,1)), color-stop(81%, rgba(32,124,229,1)));\n" +
    "background: -webkit-linear-gradient(left, rgba(73,155,234,1) 0%, rgba(73,155,234,1) 47%, rgba(50,138,231,1) 66%, rgba(32,124,229,1) 81%);\n" +
    "background: -o-linear-gradient(left, rgba(73,155,234,1) 0%, rgba(73,155,234,1) 47%, rgba(50,138,231,1) 66%, rgba(32,124,229,1) 81%);\n" +
    "background: -ms-linear-gradient(left, rgba(73,155,234,1) 0%, rgba(73,155,234,1) 47%, rgba(50,138,231,1) 66%, rgba(32,124,229,1) 81%);\n" +
    "background: linear-gradient(to right, rgba(73,155,234,1) 0%, rgba(73,155,234,1) 47%, rgba(50,138,231,1) 66%, rgba(32,124,229,1) 81%)\"> <div class=\"container clearfix\" style=\"margin:8%\"> <div class=\"center-block clearfix\" style=\"max-width: 550px; background-color:#fff; padding: 30px; border-radius:1%\"> <v-accordion id=\"accordionA\" class=\"vAccordion--default\" control=\"accordionA\"> <v-pane id=\"pane1\" expanded> <v-pane-header id=\"pane1-header\"> <h3 class=\"acctitle\"><i class=\"acc-closed icon-lock3\"></i><i class=\"acc-open icon-unlock\"></i>Login to your Account</h3> </v-pane-header> <v-pane-content id=\"pane1-content\"> <!--<form name=\"loginForm\" class=\"nobottommargin\" ng-submit=\"onLogin(loginObj)\">\n" +
    "              <div class=\"col_full\">\n" +
    "                <label for=\"loginForm-username\">Email:</label>\n" +
    "                <input ng-model=\"loginObj.emailId\" type=\"email\" id=\"loginForm-username\" name=\"loginForm-username\" class=\"form-control\"\n" +
    "                />\n" +
    "              </div>\n" +
    "\n" +
    "              <div class=\"col_full\">\n" +
    "                <label for=\"loginForm-password\">Password:</label>\n" +
    "                <input ng-model=\"loginObj.password\" type=\"password\" id=\"loginForm-password\" name=\"loginForm-password\" class=\"form-control\"\n" +
    "                />\n" +
    "              </div>\n" +
    "\n" +
    "              <div class=\"col_full nobottommargin\">\n" +
    "                <button type=\"submit\" class=\"button background-primary\">Login</button>\n" +
    "                <a href=\"#\" class=\"fright\">Forgot Password?</a>\n" +
    "              </div>\n" +
    "\n" +
    "            </form>--> <form class=\"form-horizontal\" name=\"loginForm\" novalidate ng-submit=\"onLoginFormSubmit(loginForm)\"> <div class=\"col_full\"> <label for=\"loginEmail\">Email</label> <input type=\"email\" class=\"form-control\" id=\"loginEmail\" name=\"loginEmail\" placeholder=\"Email\" ng-model=\"loginObj.email\" required> </div> <div class=\"col_full\"> <label for=\"loginPass\"> Password</label> <input type=\"password\" class=\"form-control\" id=\"loginPass\" name=\"loginPass\" placeholder=\"Password\" ng-model=\"loginObj.password\" required> </div> <div class=\"col_full nobottommargin\"> <button type=\"submit\" class=\"button background-primary\">Login</button> <a href=\"#\" class=\"fright\">Forgot Password?</a> </div> </form> <div class=\"line line-sm\"></div> <div class=\"center\"> <h4 style=\"margin-bottom: 15px\"> Login with:</h4> <button class=\"button button-rounded si-facebook si-colored\" ng-click=\"authenticate('facebook')\"><i class=\"icon-facebook\"></i>Facebook</button> <span class=\"hidden-xs\">or</span> <button class=\"button button-rounded si-google si-colored\" ng-click=\"authenticate('google')\"><i class=\"icon-facebook\"></i>Google</button> </div> </v-pane-content> </v-pane> <v-pane id=\"pane2\"> <v-pane-header id=\"pane2-header\"> <h3 class=\"acctitle\"><i class=\"acc-closed icon-user4\"></i><i class=\"acc-open icon-ok-sign\"></i>New Signup? Register for an Account</h3> </v-pane-header> <v-pane-content id=\"pane2-content\"> <form name=\"signUpForm\" class=\"nobottommargin\" ng-submit=\"onSignUpFormSubmit(signUpForm)\"> <div class=\"col_full\"> <label for=\"register-form-name\">Name:</label> <input type=\"text\" id=\"register-form-name\" name=\"register-form-name\" ng-model=\"signUpObj.name\" value=\"\" class=\"form-control\"> </div> <div class=\"col_full\"> <label for=\"register-form-email\">Email Address:</label> <input type=\"email\" id=\"register-form-email\" name=\"register-form-email\" ng-model=\"signUpObj.email\" value=\"\" class=\"form-control\"> </div> <div class=\"col_full\"> <label for=\"register-form-phone\">Phone:</label> <input type=\"text\" id=\"register-form-phone\" name=\"register-form-phone\" ng-model=\"signUpObj.phone\" value=\"\" class=\"form-control\"> </div> <div class=\"col_full\"> <label for=\"register-form-password\">Choose Password:</label> <input type=\"password\" id=\"register-form-password\" name=\"register-form-password\" ng-model=\"signUpObj.password\" value=\"\" class=\"form-control\"> </div> <div class=\"col_full\"> <label for=\"register-form-repassword\">Re-enter Password:</label> <input type=\"password\" id=\"register-form-repassword\" name=\"register-form-repassword\" ng-model=\"signUpObj.confirmPassword\" value=\"\" class=\"form-control\"> </div> <div class=\"col_full nobottommargin\"> <button type=\"submit\" class=\"button background-primary\">Sign Up</button> </div> </form> </v-pane-content> </v-pane> </v-accordion> </div> </div> </section> <!-- #content end --> "
  );
  ...
  $templateCache.put('views/plan-trip.html',
    ...
    "            <input ng-dblclick=\"display={display:'block'}\" ng-keypress=\"display={display:'block'}\" type=\"text\" class=\"sm-form-control required\" id=\"form-condition-1\" name=\"form-condition-1\"\n" +
    "              value=\"\">\n" +
    ...
    "            <input ng-dblclick=\"display1={display:'block'}\" ng-keypress=\"display1={display:'block'}\" type=\"text\" class=\"sm-form-control required\" id=\"form-condition-2\" name=\"form-condition-2\"\n" +
    "              value=\"\">\n" +
    "          </div>\n" +
    "\n" +
    ...
    "              <p class=\"input-group\">\n" +
    "                <input ng-dblclick=\"display2={display:'block'}\" ng-click=\"display2={display:'block'}\" type=\"text\" class=\"form-control\" popup-placement=\"top\" show-button-bar=\"false\" uib-datepicker-popup=\"{{format}}\" ng-model=\"dt\" is-open=\"popup1.opened\" datepicker-options=\"dateOptions\"\n" +
    ...
    "            <input ng-dblclick=\"display3={display:'block'}\" ng-keypress=\"display3={display:'block'}\" type=\"text\" class=\"sm-form-control required\" id=\"form-condition-4\" name=\"form-condition-4\"\n" +
    "              value=\"\">\n" +
    "          </div>\n" +
    "\n" +
    ...
    "            <input ng-dblclick=\"display4={display:'block'}\" ng-keypress=\"display4={display:'block'}\" type=\"text\" class=\"sm-form-control required\" id=\"form-condition-5\" name=\"form-condition-5\"\n" +
    "              value=\"\">\n" +
    "          </div>\n" +
    "\n" +
    "\n" +
    ...
    "            <textarea ng-dblclick=\"display7={display:'block'}\" ng-keypress=\"display7={display:'block'}\" class=\"sm-form-control required\" id=\"form-condition-13\" name=\"form-condition-13\"\n" +
    ...
    "            <input ng-dblclick=\"display8={display:'block'}\" ng-keypress=\"display8={display:'block'}\" type=\"text\" class=\"sm-form-control required\" id=\"form-condition-14\" name=\"form-condition-14\"\n" +
    "              value=\"\">\n" +
    "          </div>\n" +
    "\n" +
    ...
    "            <input ng-dblclick=\"display9={display:'block'}\" ng-keypress=\"display9={display:'block'}\" type=\"email\" class=\"sm-form-control required email\" id=\"form-condition-15\"\n" +
    ...
    "            <input ng-dblclick=\"display10={display:'block'}\" ng-keypress=\"display10={display:'block'}\" type=\"text\" class=\"sm-form-control required\" id=\"form-condition-16\" name=\"form-condition-16\"\n" +
    "              value=\"\">\n" +
    "          </div>\n" +
    "\n" +
  ...
  $templateCache.put('views/travel-plan.html',
    "<div style=\"background-color:#000;background-image: url('images/travel.jpg');background-size: cover; height:100vh\"> <div class=\"container clearfix\"> <div class=\"slider-caption-center\"> <h2 class=\"text-center\" style=\"font-size:48px;letter-spacing:0px;font-weight:600;color:#fff;margin-top:25%\" data-caption-animate=\"fadeInUp\"> It's time to travel</h2> <!--<a class=\"custom-button center-block text-center\">\n" +
    "         <span>Let's Wander</span> <i style=\"margin-left:10px;\" class=\"icon-angle-right\"></i></a>--> </div> </div> </div> <section id=\"content\" style=\"padding:0 6% 10% 6%\"> <div style=\"height:100vh\"> <h2 class=\"paul-title\"> Travel Inspiration </h2> <p style=\"font-size:2rem\" class=\"text-center\"> Your choices, Your friends, Your travel plans </p><div style=\"display:block;height:2px;width:30px;background:#dc221a;margin-left:auto;margin-right:auto;margin-bottom:0\"> </div> <p></p> <div class=\"row\"> <div id=\"carousel-example-generic\" class=\"carousel slide hidden-xs\" data-ride=\"carousel\"> <a style=\"background-color: rgb(255, 255, 255);\n" +
    "    border: 0px;\n" +
    "    border-radius: 50%;\n" +
    "    cursor: pointer;\n" +
    "    display: block;\n" +
    ...
    "    top: 0;\n" +
    "    z-index: 20;\n" +
    "    right: -2.22222em\" class=\"btn\" href=\"#carousel-example-generic\" data-slide=\"next\"> <i style=\"margin:7px 0 0 0; font-size:15px; font-weight:600\" class=\"icon-angle-right\"></i></a> <!-- Wrapper for slides <--> <div class=\"carousel-inner\"> <div class=\"item active\" style=\"padding:2% 0 2% 2%\"> <div class=\"row\"> <div class=\"col-sm-3 nopadding\"> <div ng-click=\"heading1.isOpen = !heading1.isOpen ; getTravelInspirationDetail(slider[0].id)\" style=\"cursor:pointer\"> <div class=\"paul-slide\"> <img style=\"object-fit:cover; width:100%; height:100%\" ng-src=\"{{slider[0].imageUrl}}\" class=\"img-responsive\" alt=\"a\"> </div> <span class=\"paul-slider-caption\"> {{slider[0].text}}</span> </div> </div> <div class=\"col-sm-3 nopadding\"> <div ng-click=\"heading1.isOpen = !heading1.isOpen ; getTravelInspirationDetail(slider[1].id)\" style=\"cursor:pointer\"> <div class=\"paul-slide\"> <img style=\"object-fit:cover; width:100%; height:100%\" ng-src=\"{{slider[1].imageUrl}}\" class=\"img-responsive\" alt=\"a\"> </div> <span class=\"paul-slider-caption\"> {{slider[1].text}}</span> </div> </div> <div class=\"col-sm-3 nopadding\"> <div ng-click=\"heading1.isOpen = !heading1.isOpen ; getTravelInspirationDetail(slider[2].id)\" style=\"cursor:pointer\"> <div class=\"paul-slide\"> <img style=\"object-fit:cover; width:100%; height:100%\" ng-src=\"{{slider[2].imageUrl}}\" class=\"img-responsive\" alt=\"a\"> </div> <span class=\"paul-slider-caption\"> {{slider[2].text}}</span> </div> </div> <div class=\"col-sm-3 nopadding\"> <div ng-click=\"heading1.isOpen = !heading1.isOpen ; getTravelInspirationDetail(slider[3].id)\" style=\"cursor:pointer\"> <div class=\"paul-slide\"> <img style=\"object-fit:cover; width:100%; height:100%\" ng-src=\"{{slider[3].imageUrl}}\" class=\"img-responsive\" alt=\"a\"> </div> <span class=\"paul-slider-caption\"> {{slider[3].text}}</span> </div> </div> </div> </div> <div class=\"item\" style=\"padding:2% 2% 2% 0%\"> <div class=\"row\"> <div class=\"col-sm-3 nopadding\"> <div ng-click=\"heading1.isOpen = !heading1.isOpen ; getTravelInspirationDetail(slider[4].id)\" style=\"cursor:pointer\"> <div class=\"paul-slide\"> <img style=\"object-fit:cover; width:100%; height:100%\" ng-src=\"{{slider[4].imageUrl}}\" class=\"img-responsive\" alt=\"a\"> </div> <span class=\"paul-slider-caption\"> {{slider[4].text}}</span> </div> </div> <div class=\"col-sm-3 nopadding\"> <div ng-click=\"heading1.isOpen = !heading1.isOpen ; getTravelInspirationDetail(slider[5].id)\" style=\"cursor:pointer\"> <div class=\"paul-slide\"> <img style=\"object-fit:cover; width:100%; height:100%\" ng-src=\"{{slider[5].imageUrl}}\" class=\"img-responsive\" alt=\"a\"> </div> <span class=\"paul-slider-caption\"> {{slider[5].text}}</span> </div> </div> <div class=\"col-sm-3 nopadding\"> <div ng-click=\"heading1.isOpen = !heading1.isOpen ; getTravelInspirationDetail(slider[6].id)\" style=\"cursor:pointer\"> <div class=\"paul-slide\"> <img style=\"object-fit:cover; width:100%; height:100%\" ng-src=\"{{slider[6].imageUrl}}\" class=\"img-responsive\" alt=\"a\"> </div> <span class=\"paul-slider-caption\"> {{slider[6].text}}</span> </div> </div> <div class=\"col-sm-3 nopadding\"> <div ng-click=\"heading1.isOpen = !heading1.isOpen ; getTravelInspirationDetail(slider[7].id)\" style=\"cursor:pointer\"> <div class=\"paul-slide\"> <img style=\"object-fit:cover; width:100%; height:100%\" ng-src=\"{{slider[7].imageUrl}}\" class=\"img-responsive\" alt=\"a\"> </div> <span class=\"paul-slider-caption\"> {{slider[7].text}}</span> </div> </div> </div> </div> </div> </div> </div> </div> </section> <div id=\"accordion\" class=\"container\"> <uib-accordion> <uib-accordion-group is-open=\"heading1.isOpen\"> <div class=\"container\" ng-show=\"heading1.isOpen\"> <div class=\"row row-centered\"> <div style=\"margin-bottom:2%\" ng-repeat=\"inspiration in inspirations\" class=\"col-xs-4 col-centered col-fixed\"> <a ui-sref=\"destination.detail({id: inspiration.id})\"> <div class=\"photo\" style=\"cursor:pointer; width: 100%;\n" +
    "    height: 100%;\n" +
    "    float: left;\n" +
    "    overflow: hidden;\n" +
    "    position: relative;\n" +
    ...
    "    font-weight: 400;\n" +
    "    padding: 10px;\n" +
    "    background: rgba(0,0,0,0.6)\" class=\"ng-binding\">{{inspiration.name}}</h2> </div> </div> </a> </div> </div> </div> </uib-accordion-group> </uib-accordion> </div> <section id=\"articles\" class=\"container\"> <div class=\"topmargin\"> <h2 ui-sref=\"blog.list\" style=\"cursor:pointer\" class=\"paul-title\"> Recent Articles </h2> <p style=\"font-size:2rem\" class=\"text-center\"> Live the wanderlust through words </p><div style=\"display:block;height:2px;width:30px;background:#dc221a;margin-left:auto;margin-right:auto;margin-bottom:0\"> </div> <p></p> </div> <div style=\"overflow:hidden; margin-bottom:-5%\"> <div ui-sref=\"blog.list\" class=\"image\" style=\"height: 350px; width: 50%;\n" +
    "    float: left;background-size: cover;\n" +
    "    background-position: 50%;\n" +
    "    transition: .4s;\n" +
    "    overflow: hidden\"> <picture> <!--<source media=\"(min-width: 1280px)\" srcset=\"https://www.roughguides.com/wp-content/uploads/2016/04/pier-440339-660x420.jpg 1280w\">\n" +
    "        <source media=\"(min-width: 960px)\" srcset=\"https://www.roughguides.com/wp-content/uploads/2016/04/pier-440339-660x420.jpg 960w\">\n" +
    "        <source media=\"(min-width: 640px)\" srcset=\"https://www.roughguides.com/wp-content/uploads/2016/04/pier-440339-660x420.jpg 640w\">--> <img ng-src=\"{{articles[0].imageUrl}}\" alt=\"{{articles[0].title}}\"> </picture> </div> <div class=\"text\" style=\"margin-top:70px; height: 350px; width: 50%;\n" +
    "    float: left;text-align: left;\n" +
    "    padding: 10px 20px;\n" +
    "    position: relative\"> <h3 style=\"cursor:pointer\" ui-sref=\"blog.list\" style=\"line-height:1.2142857142857142;margin-top:0;margin-right:0;margin-bottom:0;margin-left:0;font-size:28px;font-weight:600;color:#2c3643\"> {{articles[0].title}}</h3> <div class=\"entry-content\"> <p>{{articles[0].description}}... </p> <div class=\"feature-info\"> <span class=\"icon-calendar3\"> {{articles[0].dateTime}} • {{articles[0].author}}</span> </div> </div> </div> </div> <div style=\"overflow:hidden\"> <div ui-sref=\"blog.list\" class=\"image\" style=\"height: 350px; width: 50%;\n" +
    "    float: right;background-size: cover;\n" +
    "    background-position: 50%;\n" +
    "    transition: .4s;\n" +
    "    overflow: hidden\"> <picture> <!--<source media=\"(min-width: 1280px)\" srcset=\"https://www.roughguides.com/wp-content/uploads/2016/04/pier-440339-660x420.jpg 1280w\">\n" +
    "        <source media=\"(min-width: 960px)\" srcset=\"https://www.roughguides.com/wp-content/uploads/2016/04/pier-440339-660x420.jpg 960w\">\n" +
    "        <source media=\"(min-width: 640px)\" srcset=\"https://www.roughguides.com/wp-content/uploads/2016/04/pier-440339-660x420.jpg 640w\">--> <img ng-src=\"{{articles[1].imageUrl}}\" alt=\"{{articles[1].title}}\"> </picture> </div> <div class=\"text\" style=\"margin-top:70px; height: 350px; width: 50%;\n" +
    "    float: right;text-align: right;\n" +
    "    padding: 10px 20px;\n" +
    "    position: relative\"> <h3 style=\"cursor:pointer\" ui-sref=\"blog.list\" style=\"line-height:1.2142857142857142;margin-top:0;margin-right:0;margin-bottom:0;margin-left:0;font-size:28px;font-weight:600;color:#2c3643\"> {{articles[1].title}}</h3> <div class=\"entry-content\"> <p>{{articles[1].description}}... </p> <div class=\"feature-info\"> <span class=\"icon-calendar3\"> {{articles[1].dateTime}} • {{articles[1].author}}</span> </div> </div> </div> </div> </section> "
  );
