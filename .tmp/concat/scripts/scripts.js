 ...
 */
angular.module('wanderwagon-webapp')
  .controller('HomeCtrl', ["$scope", "$timeout", "mockRemoteSvc", function ($scope, $timeout, mockRemoteSvc) {
 ...
 */
angular.module('wanderwagon-webapp')
  .controller('DestinationDetailCtrl', ["$scope", "$stateParams", "mockRemoteSvc", function ($scope, $stateParams, mockRemoteSvc) {
 ...
 */
angular.module('wanderwagon-webapp')
  .controller('TravelPlanCtrl', ["$scope", "mockRemoteSvc", function ($scope, mockRemoteSvc) {
...
angular.module('wanderwagon-webapp').run(['$templateCache', function($templateCache) {
  ...
  $templateCache.put('views/destination-detail.html',
    ...
    "    top: 0px;\n" +
    "    z-index: 20;\n" +
    "    left: -2.22222em\" class=\"btn\" href=\"#carousel-places-generic\" data-slide=\"prev\"> <i style=\"margin:7px 0 0 0px; font-size:15px; font-weight:600\" class=\"icon-angle-left\"></i> </a> <a style=\"background-color: rgb(255, 255, 255);\n" +
    "    border: 0px;\n" +
    "    border-radius: 50%;\n" +
    "    cursor: pointer;\n" +
    "    display: block;\n" +
    ...
    "    top: 0px;\n" +
    "    z-index: 20;\n" +
    "    left: -2.22222em\" class=\"btn\" href=\"#carousel-activites-generic\" data-slide=\"prev\"> <i style=\"margin:7px 0 0 0px; font-size:15px; font-weight:600\" class=\"icon-angle-left\"></i> </a> <a style=\"background-color: rgb(255, 255, 255);\n" +
    "    border: 0px;\n" +
    "    border-radius: 50%;\n" +
    "    cursor: pointer;\n" +
    "    display: block;\n" +
    ...
    "    top: 0;\n" +
    "    z-index: 20;\n" +
    "    right: -2.22222em\" class=\"btn\" href=\"#carousel-activites-generic\" data-slide=\"next\"> <i style=\"margin:7px 0 0 0; font-size:15px; font-weight:600\" class=\"icon-angle-right\"></i></a> <!-- Wrapper for slides <--> <div class=\"carousel-inner\"> <div class=\"item active\" style=\"padding:2% 0 2% 2%\"> <div class=\"row\"> <div class=\"col-sm-3 nopadding\" ng-repeat=\"slide in activitiesViewData\"> <div ng-click=\"heading1.isOpen = !heading1.isOpen; getTravelInspirationDetail(slide.id)\" style=\"cursor:pointer\"> <div class=\"paul-slide\"> <img style=\"object-fit:cover; width:100%; height:100%\" ng-src=\"{{slide.imageUrl}}\" class=\"img-responsive\" alt=\"{{slide.name}}\"> </div> <span class=\"paul-slider-caption\"> {{slide.name}}</span> </div> </div> </div> </div> <div class=\"item\" style=\"padding:2% 2% 2% 0%\"> <div class=\"row\"> <div class=\"col-sm-3 nopadding\" ng-repeat=\"slide in activitiesData\"> <div ng-click=\"heading1.isOpen = !heading1.isOpen; getTravelInspirationDetail(slide.id) \" style=\"cursor:pointer\"> <div class=\"paul-slide\"> <img style=\"object-fit:cover; width:100%; height:100%\" ng-src=\"{{slide.imageUrl}}\" class=\"img-responsive\" alt=\"{{slide.name}}\"> </div> <span class=\"paul-slider-caption\"> {{slide.name}}</span> </div> </div> </div> </div> </div> </div> </div> </div> <uib-accordion> <uib-accordion-group is-open=\"heading2.isOpen\"> <div class=\"center-block\" style=\"width:80%\"> <div class=\"topmargin\"> <h2 style=\"text-align:center;margin:0rem 0 2rem 0;letter-spacing:-0.45px;line-height:1;font-weight:300;font-size:3.8rem\"> Name <div style=\"display:block;height:2px;width:30px;background:#dc221a;margin-left:auto;margin-right:auto;margin-bottom:0;margin-top:15px\"> </div> </h2> </div> <div class=\"pull-left\" style=\"width:30%\"> <a href=\"images/blog3.jpg\"><img height=\"350px\" width=\"100%\" src=\"images/blog3.jpg\" alt=\"Standard Post with Image\"></a> </div> <div class=\"pull-right\" style=\"width:70%; padding-left:10px\"> <h4 style=\"line-height:1.2142857142857142;font-size:18px;font-weight:200;color:#2c3643\"> What is it.....</h4> <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Cupiditate, asperiores quod est tenetur in. Eligendi, deserunt, blanditiis est quisquam doloribus voluptate id aperiam ea ipsum magni aut perspiciatis rem voluptatibus officia eos rerum deleniti quae nihil facilis repellat atque vitae voluptatem libero at eveniet veritatis ab facere. </p> <h4 style=\"line-height:1.2142857142857142;font-size:18px;font-weight:200;color:#2c3643\"> Place Of Conduct</h4> <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Cupiditate, asperiores quod est tenetur in. Eligendi, deserunt. </p> <h4 style=\"line-height:1.2142857142857142;font-size:18px;font-weight:200;color:#2c3643\"> Preferred Timings -</h4> <h4 style=\"line-height:1.2142857142857142;font-size:18px;font-weight:200;color:#2c3643\"> Duration -</h4> <h4 style=\"line-height:1.2142857142857142;font-size:18px;font-weight:200;color:#2c3643\"> Pricing -</h4> </div> </div> </uib-accordion-group> </uib-accordion> </section> <section> <div class=\"topmargin\"> <h2 style=\"text-align:center;margin:8rem 0 8rem 0;letter-spacing:-0.45px;line-height:1;font-weight:300;font-size:3.8rem\"> Why we love Destination ? <div style=\"display:block;height:2px;width:30px;background:#dc221a;margin-left:auto;margin-right:auto;margin-bottom:0;margin-top:15px\"> </div> </h2> </div> <p style=\"color: #67747c;\n" +
    ...
    "    top: 0px;\n" +
    "    z-index: 20;\n" +
    "    left: -2.22222em\" class=\"btn\" href=\"#carousel-next-generic\" data-slide=\"prev\"> <i style=\"margin:7px 0 0 0px; font-size:15px; font-weight:600\" class=\"icon-angle-left\"></i> </a> <a style=\"background-color: rgb(255, 255, 255);\n" +
    "    border: 0px;\n" +
    "    border-radius: 50%;\n" +
    "    cursor: pointer;\n" +
    "    display: block;\n" +
    ...
    "    top: 0;\n" +
    "    z-index: 20;\n" +
    "    right: -2.22222em\" class=\"btn\" href=\"#carousel-next-generic\" data-slide=\"next\"> <i style=\"margin:7px 0 0 0; font-size:15px; font-weight:600\" class=\"icon-angle-right\"></i></a> <!-- Wrapper for slides <--> <div class=\"carousel-inner\"> <div class=\"item active\" style=\"padding:2% 0 2% 2%\"> <div class=\"row\"> <div class=\"col-sm-3 nopadding\" ng-repeat=\"slide in activitiesViewData\"> <div ng-click=\"heading1.isOpen = !heading1.isOpen; getTravelInspirationDetail(slide.id)\" style=\"cursor:pointer\"> <div class=\"paul-slide\"> <img style=\"object-fit:cover; width:100%; height:100%\" ng-src=\"{{slide.imageUrl}}\" class=\"img-responsive\" alt=\"{{slide.name}}\"> </div> <span class=\"paul-slider-caption\"> {{slide.name}}</span> </div> </div> </div> </div> <div class=\"item\" style=\"padding:2% 2% 2% 0%\"> <div class=\"row\"> <div class=\"col-sm-3 nopadding\" ng-repeat=\"slide in activitiesData\"> <div ng-click=\"heading1.isOpen = !heading1.isOpen; getTravelInspirationDetail(slide.id) \" style=\"cursor:pointer\"> <div class=\"paul-slide\"> <img style=\"object-fit:cover; width:100%; height:100%\" ng-src=\"{{slide.imageUrl}}\" class=\"img-responsive\" alt=\"{{slide.name}}\"> </div> <span class=\"paul-slider-caption\"> {{slide.name}}</span> </div> </div> </div> </div> </div> </div> </div> </div> </section> "
  );
  ...
  $templateCache.put('views/home.html',
    "<div style=\"background-color:#000;background-image: url('images/home-bg.jpg');background-size: cover; height:100vh\"> <div class=\"container clearfix\"> <div class=\"slider-caption-center\"> <h2 class=\"text-center\" style=\"margin-bottom:0px;font-size:32px;letter-spacing:1px;font-weight:600;color:#fff;margin-top:300px\"> WANDERWAGON MAKES YOUR GROUP TRIP</h2> <h2 class=\"text-center\" style=\"margin-bottom:0px;font-size:32px;letter-spacing:1px;font-weight:600;color:#fff\"> {{changingText}}</h2> <p style=\"font-size:2.5rem; margin-bottom:50px; color:#fff\" class=\"text-center\"> \"Wanderwagon is the perfect partner to plan that much awaited trip with your buddies\" </p> <a href=\"#content\" du-smooth-scroll=\"\" du-scrollspy=\"\" duration=\"800\" class=\"custom-button center-block text-center\"> <span>Let's Wander</span> <i style=\"margin-left:10px\" class=\"icon-angle-right\"></i></a> </div> </div> </div> <section id=\"content\" style=\"padding:0 6% 10% 6%\"> <div style=\"height:100vh\"> <h2 class=\"paul-title\"> Travel Inspiration </h2> <p style=\"font-size:2rem\" class=\"text-center\"> Your choices, Your friends, Your travel plans </p><div style=\"display:block;height:2px;width:30px;background:#dc221a;margin-left:auto;margin-right:auto;margin-bottom:0\"> </div> <p></p> <div class=\"row\"> <div id=\"carousel-example-generic\" class=\"carousel slide hidden-xs\" data-ride=\"carousel\"> <a style=\"background-color: rgb(255, 255, 255);\n" +
    "    border: 0px;\n" +
    "    border-radius: 50%;\n" +
    "    cursor: pointer;\n" +
    "    display: block;\n" +
    ...
    "    top: 0;\n" +
    "    z-index: 20;\n" +
    "    right: -2.22222em\" class=\"btn\" href=\"#carousel-example-generic\" data-slide=\"next\"> <i style=\"margin:7px 0 0 0; font-size:15px; font-weight:600\" class=\"icon-angle-right\"></i></a> <!-- Wrapper for slides <--> <div class=\"carousel-inner\"> <div class=\"item active\" style=\"padding:2% 0 2% 2%\"> <div class=\"row\"> <div class=\"col-sm-3 nopadding\" ng-repeat=\"slide in sliderViewData\"> <div ng-click=\"heading1.isOpen = !heading1.isOpen; getTravelInspirationDetail(slide.id)\" style=\"cursor:pointer\"> <div class=\"paul-slide\"> <img style=\"object-fit:cover; width:100%; height:100%\" ng-src=\"{{slide.imageUrl}}\" class=\"img-responsive\" alt=\"{{slide.text}}\"> </div> <span class=\"paul-slider-caption\"> {{slide.text}}</span> </div> </div> </div> </div> <div class=\"item\" style=\"padding:2% 2% 2% 0%\"> <div class=\"row\"> <div class=\"col-sm-3 nopadding\" ng-repeat=\"slide in slider\"> <div ng-click=\"heading1.isOpen = !heading1.isOpen; getTravelInspirationDetail(slide.id) \" style=\"cursor:pointer\"> <div class=\"paul-slide\"> <img style=\"object-fit:cover; width:100%; height:100%\" ng-src=\"{{slide.imageUrl}}\" class=\"img-responsive\" alt=\"{{slide.text}}\"> </div> <span class=\"paul-slider-caption\"> {{slide.text}}</span> </div> </div> </div> </div> </div> </div> </div> </div> </section> <div class=\"container\"> <uib-accordion> <uib-accordion-group is-open=\"heading1.isOpen\"> <div class=\"container\"> <div class=\"row row-centered\"> <div style=\"margin-bottom:2%\" ng-repeat=\"inspiration in inspirations\" class=\"col-xs-4 col-centered col-fixed\"> <a ui-sref=\"destination.detail({id: inspiration.id})\"> <div class=\"photo\" style=\"cursor:pointer; width: 100%;\n" +
    "    height: 100%;\n" +
    "    float: left;\n" +
    "    overflow: hidden;\n" +
    "    position: relative;\n" +
