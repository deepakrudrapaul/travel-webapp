...
angular.module('wanderwagon-webapp').run(['$templateCache', function($templateCache) {
  ...
  $templateCache.put('views/events.html',
    ...
    "      <p class=\"text-center primary-title-1\">{{detail.title}}</p> --> </div> </div> </div> <section id=\"about\"> <div class=\"container clearfix\"> <div> <h2 class=\"paul-title\" style=\"margin-top:5%\"> {{eventDetail.description}} </h2> <div class=\"underline\" style=\"margin-bottom:2rem\"> </div> </div> <div class=\"center-block custom-para\"> <p>{{eventDetail.paragraphs[0].text}}</p> <p>{{eventDetail.paragraphs[1].text}}</p> <p>{{eventDetail.paragraphs[2].text}}</p> <p><strong>{{eventDetail.paragraphs[3].text}}</strong></p> <p><strong>{{eventDetail.paragraphs[4].text}}</strong></p> </div> </div> </section> <section id=\"content\"> <div class=\"container\"> <div class=\"row row-centered\"> <div style=\"margin-bottom:2%\" ng-repeat=\"location in eventDetail.eventLocations\" class=\"col-sm-4 col-centered col-fixed\"> <a ng-href=\"{{location.pdfUrl}}\"> <div class=\"photo\" style=\"cursor:pointer; width: 100%;\n" +
    "    height: 100%;\n" +
    "    float: left;\n" +
    "    overflow: hidden;\n" +
    "    position: relative;\n" +
