...
angular.module('wanderwagon-webapp').run(['$templateCache', function($templateCache) {
  ...
  $templateCache.put('views/events.html',
    ...
    "      <p class=\"text-center primary-title-1\">{{detail.title}}</p> --> </div> </div> </div> <div class=\"mobile-cover-page\" style=\"background-color:#36353B;background: url({{eventDetail.mobileEventImage}}) no-repeat center center fixed;background-attachment: fixed;\n" +
    ...
    "      <p class=\"text-center primary-title-1\">{{detail.title}}</p> --> </div> </div> </div> <section id=\"about\"> <div class=\"container clearfix\"> <div> <h2 class=\"paul-title\" style=\"margin-top:5%\"> About {{eventDetail.eventName}} </h2> <div class=\"underline\" style=\"margin-bottom:2rem\"> </div> </div> <div class=\"center-block custom-para\"> <p ng-repeat=\"para in eventDetail.paragraphs\">{{para.text}}</p> </div> </div> </section> <section id=\"content\"> <div class=\"container\"> <div class=\"row row-centered\"> <div style=\"margin-bottom:2%\" ng-repeat=\"location in eventDetail.eventLocations\" class=\"col-sm-4 col-centered col-fixed\"> <a ng-href=\"{{location.pdfUrl}}\"> <div class=\"photo\" style=\"cursor:pointer; width: 100%;\n" +
    "    height: 100%;\n" +
    "    float: left;\n" +
    "    overflow: hidden;\n" +
    "    position: relative;\n" +
