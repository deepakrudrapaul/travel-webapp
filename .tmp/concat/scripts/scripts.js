...
angular.module('wanderwagon-webapp').run(['$templateCache', function($templateCache) {
  ...
  $templateCache.put('views/home.html',
    ...
    "    top: 0;\n" +
    "    z-index: 20;\n" +
    "    right: -2.22222em\" class=\"btn\" href=\"#carousel-example-generic\" data-slide=\"next\"> <i style=\"margin:7px 0 0 0; font-size:15px; font-weight:600\" class=\"icon-angle-right\"></i></a> <!-- Wrapper for slides <--> <div class=\"carousel-inner\"> <div class=\"item active\"> <div class=\"row\" style=\"padding:2%\"> <div class=\"col-sm-3 nopadding\"> <div ng-click=\"heading1.isOpen = !heading1.isOpen\" style=\"cursor:pointer\"> <div class=\"paul-slide\"> <img style=\"object-fit:cover; width:100%; height:100%\" src=\"images/home-bg.jpg\" class=\"img-responsive\" alt=\"a\"> </div> <p class=\"paul-slider-caption\"> {{images[0].text}}</p> </div> </div> <div class=\"col-sm-3 nopadding\"> <div ng-click=\"heading1.isOpen = !heading1.isOpen\" style=\"cursor:pointer\"> <div class=\"paul-slide\"> <img style=\"object-fit:cover; width:100%; height:100%\" src=\"images/destination-bg.jpg\" class=\"img-responsive\" alt=\"a\"> </div> <p class=\"paul-slider-caption\"> {{images[1].text}}</p> </div> </div> <div class=\"col-sm-3 nopadding\"> <div ng-click=\"heading1.isOpen = !heading1.isOpen\" style=\"cursor:pointer\"> <div class=\"paul-slide\"> <img style=\"object-fit:cover; width:100%; height:100%\" src=\"images/manipur.jpg\" class=\"img-responsive\" alt=\"a\"> </div> <p class=\"paul-slider-caption\"> {{images[2].text}}</p> </div> </div> <div class=\"col-sm-3 nopadding\"> <div ng-click=\"heading1.isOpen = !heading1.isOpen\" style=\"cursor:pointer\"> <div class=\"paul-slide\"> <img style=\"object-fit:cover; width:100%; height:100%\" src=\"images/destination-detail-bg.jpg\" class=\"img-responsive\" alt=\"a\"> </div> <p class=\"paul-slider-caption\"> {{images[3].text}}</p> </div> </div> </div> </div> <div class=\"item\"> <div class=\"row\" style=\"padding:2%\"> <div class=\"col-sm-3 nopadding\"> <div ng-click=\"heading1.isOpen = !heading1.isOpen\" style=\"cursor:pointer\"> <div class=\"paul-slide\"> <img style=\"object-fit:cover; width:100%; height:100%\" src=\"images/home-bg.jpg\" class=\"img-responsive\" alt=\"a\"> </div> <p class=\"paul-slider-caption\"> {{images[4].text}}</p> </div> </div> <div class=\"col-sm-3 nopadding\"> <div ng-click=\"heading1.isOpen = !heading1.isOpen\" style=\"cursor:pointer\"> <div class=\"paul-slide\"> <img style=\"object-fit:cover; width:100%; height:100%\" src=\"images/home-bg.jpg\" class=\"img-responsive\" alt=\"a\"> </div> <p class=\"paul-slider-caption\"> {{images[5].text}}</p> </div> </div> <div class=\"col-sm-3 nopadding\"> <div ng-click=\"heading1.isOpen = !heading1.isOpen\" style=\"cursor:pointer\"> <div class=\"paul-slide\"> <img style=\"object-fit:cover; width:100%; height:100%\" src=\"images/home-bg.jpg\" class=\"img-responsive\" alt=\"a\"> </div> <p class=\"paul-slider-caption\"> {{images[5].text}}</p> </div> </div> <div class=\"col-sm-3 nopadding\"> <div ng-click=\"heading1.isOpen = !heading1.isOpen\" style=\"cursor:pointer\"> <div class=\"paul-slide\"> <img style=\"object-fit:cover; width:100%; height:100%\" src=\"images/destination-bg.jpg\" class=\"img-responsive\" alt=\"a\"> </div> <p class=\"paul-slider-caption\"> {{images[0].text}}</p> </div> </div> </div> </div> </div> </div> </div> </div> </section> <div class=\"container\"> <uib-accordion> <uib-accordion-group is-open=\"heading1.isOpen\"> <div style=\"padding-left:50px\" id=\"posts\" class=\"events small-thumbs\"> <div class=\".col-md-4\" ng-repeat=\"destination in destinations\"> <div class=\"entry-image\" style=\"padding-bottom:10px\"> <a href=\"#\" ui-sref=\"destination.detail({id: destination.id})\"> <img ng-src=\"{{destination.imageUrl}}\" alt=\"Inventore voluptates velit totam ipsa tenetur\"> <h3 class=\"text-center\">{{destination.name}}</h3> </a> </div> </div> </div> </uib-accordion-group> </uib-accordion> </div> <section id=\"content\" class=\"container\"> <div class=\"topmargin\"> <h2 class=\"paul-title\"> The Blog </h2> <p style=\"font-size:2rem\" class=\"text-center\"> Live the wanderlust through words </p><div style=\"display:block;height:2px;width:30px;background:#dc221a;margin-left:auto;margin-right:auto;margin-bottom:0\"> </div> <p></p> </div> <div style=\"overflow:hidden; margin-bottom:-5%\"> <div ui-sref=\"blog.list\" class=\"image\" style=\"height: 350px; width: 50%;\n" +
    ...
    "        {{postDetail.title}}\n" +
    "      </div>--> <div style=\"width:40%; height:100vh; float:left; position:absolute; left:0px; top:0px; z-index:1; background-color: rgba(0,0,0,.66); padding:5px; color: #FFF; font-weight:bold\"> <div style=\"padding:14% 5%\"> <div> <div> <h3 style=\"margin: 0;font-size: 25px;font-weight: 600;\n" +
    "    line-height: normal;\n" +
    "    letter-spacing: 2px;\n" +
