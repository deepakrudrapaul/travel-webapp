 ...
 */
angular.module('wanderwagon-webapp')
  .controller('EventCtrl', ["$scope", "$stateParams", "auth", "$rootScope", "mockRemoteSvc", "$document", function ($scope, $stateParams, auth, $rootScope, mockRemoteSvc, $document) {
...
angular.module('wanderwagon-webapp').run(['$templateCache', function($templateCache) {
  ...
  $templateCache.put('views/contact.html',
    ...
    "					<p>Error</p>\n" +
    "				</div>\n" +
    "			</div>--> </div> </div> </div> <div class=\"modal fade\" id=\"contactImageModal\" tabindex=\"-1\" role=\"dialog\" aria-labelledby=\"contactImageModal\"> <div class=\"modal-dialog\" role=\"document\"> <button style=\"color:#FFF; font-size:40px\" type=\"button\" class=\"close\" data-dismiss=\"modal\" aria-label=\"Close\"><span aria-hidden=\"true\">&times;</span></button> <div class=\"modal-content contactImageModal\"> <div class=\"modal-body\"> </div> </div> </div> </div> </section>"
  );
  ...
  $templateCache.put('views/events.html',
    "<div class=\"cover-page\" style=\"background-color:#36353B;background-image: url({{eventDetail.eventImage}});background-attachment: fixed;\n" +
    "background-position: center;\n" +
    "background-repeat: no-repeat;\n" +
  ...
  $templateCache.put('views/holi.html',
    ...
    "background-size: cover; height:100vh\"> </div> <section id=\"about\"> <div class=\"container clearfix\"> <div> <h2 class=\"paul-title\" style=\"margin-top:5%\"> Mathura ki Holi </h2> <div class=\"underline\" style=\"margin-bottom:2rem\"> </div> </div> <div class=\"custom-para-event\"> <p style=\"margin-bottom:20px\">How do you see yourself playing Holi this year? Same old or Some bold? It is for you to decide. <strong> Kyuki Mathura ki Holi nahi kheli, to kya kia?</strong> Let us help you check one more item off your bucket list as you soak into the vibrancy of this festival.</p> <p style=\"margin-bottom:20px\"> Travel back in time to witness the authentic Holi of Mathura. Follow the steps of Lord Krishna and let the inner kid take over. Let go of the inhibitions and let others watch you bring your A-Game. This Holi there's no stopping you; Cause what happens in Mathura stays in Mathura! </p> <p style=\"font-size:2.2rem; margin-bottom:20px\"> <strong> Celebrations start a week in advance and here is when and where you should be while celebrating Holi in Mathura :- </strong> </p> <ul style=\"padding-left:30px;   list-style-type: square; font-size:2rem\"> <li> <div class=\"custom-para-event\"> <p style=\"margin-bottom:20px\"> <strong> Lathmar Holi - 24.02.2018-25.02.2018 </strong> <br> What literally translates to a festival of lathis (sticks) and colours, Lathmar Holi lives up to every bit of its name. </p> </div> </li> <li> <div class=\"custom-para-event\"> <p style=\"margin-bottom:20px\"> <strong> Phoolon Wali Holi - 26.02.2018 </strong> <br> Flowers and showers, Phoolon Wali Holi lives up to every bit of its name. </p> </div> </li> <li> <div class=\"custom-para-event\"> <p style=\"margin-bottom:20px\"> <strong>Widow’s Holi- 27.02.2018 </strong> <br> The only day when a widow’s saree turns into a blank canvas to be filled with colours. </p> </div> </li> <li> <div class=\"custom-para-event\"> <p style=\"margin-bottom:20px\"> <strong> Holi at Vrindavan- 01.03.2018 </strong> <br> The festivities begin as the gates to the temple of Banke Bihari open up for you to play Holi with the lord himself. </p> </div> </li> <li> <div class=\"custom-para-event\"> <p style=\"margin-bottom:20px\"> <strong> Holi at Mathura- 01.03.2018 </strong> <br> Witness the rest of the Holi along the lanes of Mathura. </p> </div> </li> <li> <div class=\"custom-para-event\"> <p style=\"margin-bottom:20px\"> <strong> Holika Dahan- 01.03.2018 </strong> <br> Celebrate the victory of good over evil as you watch the effigy of Holika burn down to ashes. </p> </div> </li> <li> <div class=\"custom-para-event\"> <p style=\"margin-bottom:20px\"> <strong>Grand Holi- 02.03.2018 </strong> <br> Travel back in time and witness the authentic holi of Mathura amongst the riot of colours. </p> </div></li> <li> <div class=\"custom-para-event\"> <p style=\"margin-bottom:20px\"> <strong> Huranga- 03.03.2018 </strong> <br>It’s not over yet! Let the inner child take over a day after. </p> </div> </li> </ul> </div> </div> </section> <section class=\"clearfix custom-padding\" id=\"places\"> <h2 style=\"margin-top:5%\" class=\"paul-title\"> Our Plans, Your Choice </h2> <div class=\"underline\" style=\"margin-bottom:5rem\"> </div> <div class=\"row row-centered\"> <div style=\"margin-bottom:2%\" ng-repeat=\"plan in travelPlans\" class=\"col-sm-6 col-centered col-fixed\"> <div class=\"photo\" style=\"cursor:pointer; width: 100%;\n" +
    "      height: 100%;\n" +
    "      overflow: hidden;\n" +
    "      position: relative;\n" +
    "      text-align: center;\n" +
  ...
  $templateCache.put('views/plan-trip.html',
    ...
    "		============================================= --> <section id=\"content\"> <div class=\"content-wrap\"> <div class=\"container clearfix\"> <div style=\"float: none; display: block; margin-right: auto; margin-left: auto\" class=\"col_half nobottommargin\"> <h4> Let's break the ice because this can't be done without you.</h4> <h2>ABOUT THE TRIP</h2> <form id=\"conditional-form\" name=\"tripForm\" class=\"nobottommargin\" ng-submit=\"submitTravelPlanForm(tripForm)\"> <h4> <strong> Let's see what you have planned. </strong> </h4> <div class=\"col_full\"> <label for=\"form-condition-1\">WHERE ARE YOU HEADED?</label> <input placeholder=\"EX. DELHI\" pattern=\"^[a-zA-Z ]*$\" type=\"text\" class=\"form-control required\" id=\"form-condition-1\" name=\"form-condition-1\" ng-model=\"formObj.departureCity\" required> <!-- <a href=\"#\" class=\"button button-border button-rounded\"><i class=\"icon-gift\"></i>Button</a> --> </div> <div class=\"col_full\" id=\"form-condition-2-wrap\"> <label for=\"form-condition-2\">WHERE WOULD YOU START FROM?</label> <input placeholder=\"EX. MUMBAI\" pattern=\"^[a-zA-Z ]*$\" type=\"text\" class=\"form-control required\" id=\"form-condition-2\" name=\"form-condition-2\" ng-model=\"formObj.destination\" required> </div> <div class=\"input-daterange travel-date-group\"> <div class=\"col_full\"> <label for=\"form-condition-3\">WHEN DO YOU WANT TO LEAVE?</label> <p class=\"input-group\"> <input ng-model=\"formObj.departureTime\" ng-click=\"display2={display:'block'}\" type=\"text\" class=\"form-control\" popup-placement=\"top\" show-button-bar=\"false\" uib-datepicker-popup=\"{{format}}\" ng-model=\"dt\" is-open=\"popup1.opened\" datepicker-options=\"dateOptions\" ng-required=\"true\" alt-input-formats=\"altInputFormats\" required> <span class=\"input-group-btn\"> <button type=\"button\" class=\"btn btn-default\" ng-touch=\"open1(); display2={display:'block'}\" ng-click=\"open1(); display2={display:'block'}\"> <i class=\"glyphicon glyphicon-calendar\"></i> </button> </span> </p> </div> </div> <div class=\"col_full\" id=\"form-condition-4-wrap\"> <label for=\"form-condition-4\">WHAT WOULD BE THE DURATION OF YOUR TRIP ( In days)?</label> <input required ng-model=\"formObj.duration\" min=\"1\" placeholder=\"Enter the number of days\" type=\"number\" class=\"form-control required\" id=\"form-condition-4\" name=\"form-condition-4\"> </div> <div class=\"col_full\" id=\"form-condition-5-wrap\"> <label for=\"form-condition-5\">HOW MANY PEOPLE WOULD COME ALONG? NUMBER OF PEOPLE WHO ARE PLANNING THIS TRIP INCLUDING YOU</label> <input required ng-model=\"formObj.personCount\" min=\"0\" type=\"number\" class=\"form-control required\" id=\"form-condition-5\" name=\"form-condition-5\"> </div> <div class=\"col_full\" id=\"form-condition-10-wrap\"> <label for=\"form-condition-10\">WHAT SERVICES DO YOU NEED?</label> <select required ng-model=\"formObj.servicesNeed\" ng-touch=\"display5={display:'block'}\" ng-click=\"display5={display:'block'}\" id=\"form-condition-10\" name=\"form-condition-10\" class=\"required form-control\"> <option value=\"\"> Select One </option> <option value=\"TRANSPORT\">TRANSPORT</option> <option value=\"STAY\">STAY</option> <option value=\"ACTIVITIES\">ACTIVITIES</option> </select> </div> <h4> <strong>Let's see how much you have saved.</strong> </h4> <div class=\"col_full\" id=\"form-condition-10-wrap\"> <label for=\"form-condition-10\">WHAT'S THE BUDGET OF YOUR TRIP? ( PER HEAD ) </label> <select required ng-model=\"formObj.perPersonBudget\" ng-touch=\"display5={display:'block'}\" ng-click=\"display5={display:'block'}\" id=\"form-condition-10\" name=\"form-condition-10\" class=\"required form-control\"> <option value=\"\"> SELECT ONE </option> <option value=\"5K\">LESS THAN 5K</option> <option value=\"5K to 10K\">5K TO 10K</option> <option value=\"10K to 15K\">10K TO 15K</option> <option value=\"15K to 20K\">15K TO 20K</option> <option value=\"more than 20K\">MORE THAN 20K</option> </select> </div> <div class=\"col_full\" id=\"form-condition-10-wrap\"> <label for=\"form-condition-10\">WHAT MATTERS THE MOST TO YOU?</label> <select required ng-model=\"formObj.budgetDescription\" ng-touch=\"display5={display:'block'}\" ng-click=\"display5={display:'block'}\" id=\"form-condition-10\" name=\"form-condition-10\" class=\"required form-control\"> <option value=\"\"> Select One </option> <option value=\"I would like to stick to my budget\">I WOULD LIKE TO STICK TO MY BUDGET</option> <option value=\"For a better trip, I won't mind paying a little more\">FOR A BETTER TRIP, I WON'T MIND PAYING A LITTLE MORE</option> <option value=\"Money won't be an issue, if I get the perfect trip\">MONEY WON'T BE AN ISSUE, IF I GET THE PERFECT TRIP</option> </select> </div> <div class=\"col_full\" id=\"form-condition-12-wrap\"> <label for=\"form-condition-12\">WHAT STAGE OF PLANNING DO YOU FIND YOURSELF IN?</label> <select required ng-model=\"formObj.planningStage\" ng-touch=\"display6={display:'block'}\" ng-click=\"display6={display:'block'}\" id=\"form-condition-12\" name=\"form-condition-12\" class=\"required form-control\"> <option value=\"\"> SELECT ONE </option> <option value=\"Still dreaming...not sure I'm going to this trip\">DREAMING - I really want to but haven't planned anything yet</option> <option value=\"I know I am going somewhere, but not sure about the places\">PLANNING - I'm Going somewhere, Not sure where </option> <option value=\"I am definitely going\">BOOKING - I am ready for my next adventure. </option> </select> </div> <h4> <strong>Let's see who you are.</strong> </h4> <div class=\"col_full\"> <label for=\"template-contactform-name\">NAME </label> <input placeholder=\"Enter your name\" pattern=\"[a-zA-Z][a-zA-Z ]+\" required ng-model=\"formObj.name\" type=\"text\" id=\"template-contactform-name\" name=\"template-contactform-name\" value=\"\" class=\"form-control required show-error-msg\"> </div> <div class=\"col_full\"> <label for=\"template-contactform-email\">EMAIL </label> <input placeholder=\"Enter your email id\" required ng-model=\"formObj.email\" type=\"email\" id=\"template-contactform-email\" name=\"template-contactform-email\" value=\"\" class=\"required email form-control\"> </div> <div class=\"col_full col_last\"> <label for=\"template-contactform-phone\">PHONE No.</label> <input placeholder=\"Enter your mobile no.\" pattern=\"^[0][1-9]\\d{9}$|^[1-9]\\d{9}$\" required ng-model=\"formObj.phone\" type=\"text\" id=\"template-contactform-phone\" name=\"template-contactform-phone\" value=\"\" class=\"form-control\"> </div> <div class=\"col_full\" id=\"form-condition-submit\"> <button class=\"button nomargin\" ng-click=\"submitTravelPlanForm(form)\" type=\"button\">Plan My Trip</button> </div> </form> </div> </div> </div> </section> <!-- #content end --> <div class=\"modal fade\" id=\"tripModal\" tabindex=\"-1\" role=\"dialog\" aria-labelledby=\"tripModal\"> <div class=\"modal-dialog\" role=\"document\"> <div class=\"modal-content\"> <div class=\"modal-header\" style=\"text-align:center\"> <button type=\"button\" class=\"close\" data-dismiss=\"modal\" aria-label=\"Close\"> <span aria-hidden=\"true\">&times;</span> </button> <h4 class=\"modal-title\" id=\"tripModallabel\">{{messageType}} <img style=\"margin-left:20px\" height=\"20\" width=\"20\" src=\"images/cheers.png\"> </h4> </div> <div class=\"modal-body\"> <div class=\"row\" style=\"text-align:center\"> <div style=\"padding:5%\" class=\"col-full\"> {{message}} </div> </div> </div> </div> </div> </div> <div class=\"modal fade\" id=\"plantripModal\" tabindex=\"-1\" role=\"dialog\" aria-labelledby=\"plantripModal\"> <div class=\"modal-dialog\" role=\"document\"> <button style=\"color:#FFF; font-size:40px\" type=\"button\" class=\"close\" data-dismiss=\"modal\" aria-label=\"Close\"> <span aria-hidden=\"true\">&times;</span> </button> <div class=\"modal-content plantripModal\"> <div class=\"modal-body\"> </div> </div> </div> </div> "
  );
  ...
  $templateCache.put('views/valentine.html',
    "<div class=\"cover-page\" style=\"background-color:#36353B;background-image: url('https://s3-ap-southeast-1.amazonaws.com/wanderwagon/images/events/valentine_day/valentine_cover.jpg');background-attachment: fixed;\n" +
    "background-position: center;\n" +
    "background-repeat: no-repeat;\n" +
    "background-size: cover; height:100vh\"> <div style=\"background-color:#36353B; height:100px\" class=\"clearfix\"> </div> </div> <div class=\"mobile-cover-page\" style=\"background-color:#36353B;background: url({{mobileImageUrl}}) no-repeat center center fixed;background-attachment: fixed;\n" +
    "background-size: cover; height:100vh\"> <div style=\"background-color:#36353B; height:100px\" class=\"clearfix\"> </div> </div> <section id=\"about\"> <div class=\"container clearfix\"> <div> <h2 class=\"paul-title\" style=\"margin-top:5%\"> Valentine's Day </h2> <div class=\"underline\" style=\"margin-bottom:2rem\"> </div> </div> <div class=\"custom-para-event\"> <p>Aren't we all rebels, fighting against the \"usual\". Trying to change the roles that people have given us in the stories they make up in their heads. Love is no different, being caged and trapped within the bars of a single definition. We have already made these bars weak enough for us to escape, by choosing whom or what to love, in a way we fancy.</p> <p> This Valentine's, let's break through and define love in not just one or two but million and trillion ways. Let's start with a journey to celebrate love , togetherness and freedom. Allow WanderWagon to give you the travel experiences, that would forever be cherished in your memories. </p> <p> So, Why not Pack your bags and head out for a celebratory journey ? </p> <div class=\"custom-para-event\" style=\"text-align:center\"> <p> <strong>Remember - This year it's just you and your Valentine against the world.</strong> </p> </div> </div> </div> </section> <section id=\"content\"> <div class=\"content-wrap\"> <div class=\"container clearfix\"> <div style=\"float: none; display: block; margin-right: auto; margin-left: auto\" class=\"col_half nobottommargin\"> <h2 style=\"margin-bottom:5%\">We would need a little help from you.</h2> <form id=\"conditional-form\" name=\"tripForm\" class=\"nobottommargin\" ng-submit=\"submitEventForm(tripForm)\"> <div class=\"col_full\"> <label for=\"form-condition-1\">Destination</label> <input placeholder=\"Where would you like to go?\" pattern=\"^[a-zA-Z ]*$\" type=\"text\" class=\"form-control required\" id=\"form-condition-1\" name=\"form-condition-1\" ng-model=\"formObj.destination\" required> <!-- <a href=\"#\" class=\"button button-border button-rounded\"><i class=\"icon-gift\"></i>Button</a> --> </div> <div class=\"col_full\"> <label for=\"template-contactform-name\">Name </label> <input placeholder=\"Enter your name\" pattern=\"[a-zA-Z][a-zA-Z ]+\" required ng-model=\"formObj.name\" type=\"text\" id=\"template-contactform-name\" name=\"template-contactform-name\" value=\"\" class=\"form-control required show-error-msg\"> </div> <div class=\"col_full\"> <label for=\"template-contactform-email\">Email </label> <input placeholder=\"Enter your email id\" required ng-model=\"formObj.email\" type=\"email\" id=\"template-contactform-email\" name=\"template-contactform-email\" value=\"\" class=\"required email form-control\"> </div> <div class=\"col_full col_last\"> <label for=\"template-contactform-phone\">Phone</label> <input placeholder=\"Enter your mobile no.\" pattern=\"^[0][1-9]\\d{9}$|^[1-9]\\d{9}$\" required ng-model=\"formObj.phone\" type=\"text\" id=\"template-contactform-phone\" name=\"template-contactform-phone\" value=\"\" class=\"form-control\"> </div> <div ng-style=\"display10\" class=\"col_full\" id=\"form-condition-submit\"> <button class=\"button nomargin\" type=\"submit\">Plan My Trip</button> </div> </form> </div> </div> </div> </section> <div class=\"modal fade\" id=\"eventModal\" tabindex=\"-1\" role=\"dialog\" aria-labelledby=\"eventModal\"> <div class=\"modal-dialog\" role=\"document\"> <div class=\"modal-content\"> <div class=\"modal-header\"> <button type=\"button\" class=\"close\" data-dismiss=\"modal\" aria-label=\"Close\"> <span aria-hidden=\"true\">&times;</span> </button> <h4 class=\"modal-title\" id=\"eventModallabel\">Query Form</h4> </div> <div class=\"modal-body\"> <div class=\"row\"> <div style=\"padding:0 5%\" class=\"col-full\"> <form name=\"queryForm\" class=\"nobottommargin\" ng-submit=\"onFormSubmit(queryForm)\"> <div class=\"col_full\"> <label for=\"queryName\"> <font color=\"white\">Name</font> </label> <input type=\"text\" class=\"form-control\" id=\"queryName\" name=\"queryName\" placeholder=\"Name\" ng-model=\"queryObj.name\" required> </div> <div class=\"col_full\"> <label for=\"queryPhone\"> <font color=\"white\">Phone no.</font> </label> <input type=\"tel\" class=\"form-control\" id=\"queryPhone\" name=\"queryPhone\" placeholder=\"Phone\" ng-model=\"queryObj.phone\" required> </div> <div class=\"col_full nobottommargin\"> <button type=\"submit\" class=\"button button-blue\"> <font color=\"white\">Submit</font> </button> </div> </form> </div> </div> </div> </div> </div> </div> <div class=\"modal fade\" id=\"tripModal\" tabindex=\"-1\" role=\"dialog\" aria-labelledby=\"tripModal\"> <div class=\"modal-dialog\" role=\"document\"> <div class=\"modal-content\"> <div class=\"modal-header\" style=\"text-align:center\"> <button type=\"button\" class=\"close\" data-dismiss=\"modal\" aria-label=\"Close\"> <span aria-hidden=\"true\">&times;</span> </button> <h4 class=\"modal-title\" id=\"tripModallabel\">{{messageType}}<img style=\"margin-left:20px\" height=\"20\" width=\"20\" src=\"images/cheers.png\"></h4> </div> <div class=\"modal-body\"> <div class=\"row\" style=\"text-align:center\"> <div style=\"padding:5%\" class=\"col-full\"> {{message}} </div> </div> </div> </div> </div> </div> <div class=\"modal fade\" id=\"plantripModal\" tabindex=\"-1\" role=\"dialog\" aria-labelledby=\"plantripModal\"> <div class=\"modal-dialog\" role=\"document\"> <button style=\"color:#FFF; font-size:40px\" type=\"button\" class=\"close\" data-dismiss=\"modal\" aria-label=\"Close\"> <span aria-hidden=\"true\">&times;</span> </button> <div class=\"modal-content plantripModal\"> <div class=\"modal-body\"> </div> </div> </div> </div> <div class=\"modal fade\" id=\"eventSuccessModal\" tabindex=\"-1\" role=\"dialog\" aria-labelledby=\"eventSuccessModal\"> <div class=\"modal-dialog\" role=\"document\"> <button style=\"color:#FFF; font-size:40px\" type=\"button\" class=\"close\" data-dismiss=\"modal\" aria-label=\"Close\"> <span aria-hidden=\"true\">&times;</span> </button> <div class=\"modal-content eventSuccessModal\"> <div class=\"modal-body\"> </div> </div> </div> </div> "
  );
